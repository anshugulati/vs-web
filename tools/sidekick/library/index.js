const Ae=window,Ee=Ae.ShadowRoot&&(Ae.ShadyCSS===void 0||Ae.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,or=Symbol(),go=new WeakMap;class ho{constructor(t,e,o){if(this._$cssResult$=!0,o!==or)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(Ee&&t===void 0){const o=e!==void 0&&e.length===1;o&&(t=go.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&go.set(e,t))}return t}toString(){return this.cssText}}const k=(r,...t)=>{const e=r.length===1?r[0]:t.reduce((o,a,s)=>o+(i=>{if(i._$cssResult$===!0)return i.cssText;if(typeof i=="number")return i;throw Error("Value passed to 'css' function must be a 'css' function result: "+i+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+r[s+1],r[0]);return new ho(e,r,or)},bo=Ee?r=>r:r=>r instanceof CSSStyleSheet?(t=>{let e="";for(const o of t.cssRules)e+=o.cssText;return(o=>new ho(typeof o=="string"?o:o+"",void 0,or))(e)})(r):r;var sr;const He=window,vo=He.trustedTypes,Xs=vo?vo.emptyScript:"",fo=He.reactiveElementPolyfillSupport,ar={toAttribute(r,t){switch(t){case Boolean:r=r?Xs:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,t){let e=r;switch(t){case Boolean:e=r!==null;break;case Number:e=r===null?null:Number(r);break;case Object:case Array:try{e=JSON.parse(r)}catch(o){e=null}}return e}},yo=(r,t)=>t!==r&&(t==t||r==r),ir={attribute:!0,type:String,converter:ar,reflect:!1,hasChanged:yo};class Ft extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(t){var e;this.finalize(),((e=this.h)!==null&&e!==void 0?e:this.h=[]).push(t)}static get observedAttributes(){this.finalize();const t=[];return this.elementProperties.forEach((e,o)=>{const a=this._$Ep(o,e);a!==void 0&&(this._$Ev.set(a,o),t.push(a))}),t}static createProperty(t,e=ir){if(e.state&&(e.attribute=!1),this.finalize(),this.elementProperties.set(t,e),!e.noAccessor&&!this.prototype.hasOwnProperty(t)){const o=typeof t=="symbol"?Symbol():"__"+t,a=this.getPropertyDescriptor(t,o,e);a!==void 0&&Object.defineProperty(this.prototype,t,a)}}static getPropertyDescriptor(t,e,o){return{get(){return this[e]},set(a){const s=this[t];this[e]=a,this.requestUpdate(t,s,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||ir}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const t=Object.getPrototypeOf(this);if(t.finalize(),t.h!==void 0&&(this.h=[...t.h]),this.elementProperties=new Map(t.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const e=this.properties,o=[...Object.getOwnPropertyNames(e),...Object.getOwnPropertySymbols(e)];for(const a of o)this.createProperty(a,e[a])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const o=new Set(t.flat(1/0).reverse());for(const a of o)e.unshift(bo(a))}else t!==void 0&&e.push(bo(t));return e}static _$Ep(t,e){const o=e.attribute;return o===!1?void 0:typeof o=="string"?o:typeof t=="string"?t.toLowerCase():void 0}u(){var t;this._$E_=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(t=this.constructor.h)===null||t===void 0||t.forEach(e=>e(this))}addController(t){var e,o;((e=this._$ES)!==null&&e!==void 0?e:this._$ES=[]).push(t),this.renderRoot!==void 0&&this.isConnected&&((o=t.hostConnected)===null||o===void 0||o.call(t))}removeController(t){var e;(e=this._$ES)===null||e===void 0||e.splice(this._$ES.indexOf(t)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((t,e)=>{this.hasOwnProperty(e)&&(this._$Ei.set(e,this[e]),delete this[e])})}createRenderRoot(){var t;const e=(t=this.shadowRoot)!==null&&t!==void 0?t:this.attachShadow(this.constructor.shadowRootOptions);return((o,a)=>{Ee?o.adoptedStyleSheets=a.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet):a.forEach(s=>{const i=document.createElement("style"),c=Ae.litNonce;c!==void 0&&i.setAttribute("nonce",c),i.textContent=s.cssText,o.appendChild(i)})})(e,this.constructor.elementStyles),e}connectedCallback(){var t;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$ES)===null||t===void 0||t.forEach(e=>{var o;return(o=e.hostConnected)===null||o===void 0?void 0:o.call(e)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$ES)===null||t===void 0||t.forEach(e=>{var o;return(o=e.hostDisconnected)===null||o===void 0?void 0:o.call(e)})}attributeChangedCallback(t,e,o){this._$AK(t,o)}_$EO(t,e,o=ir){var a;const s=this.constructor._$Ep(t,o);if(s!==void 0&&o.reflect===!0){const i=(((a=o.converter)===null||a===void 0?void 0:a.toAttribute)!==void 0?o.converter:ar).toAttribute(e,o.type);this._$El=t,i==null?this.removeAttribute(s):this.setAttribute(s,i),this._$El=null}}_$AK(t,e){var o;const a=this.constructor,s=a._$Ev.get(t);if(s!==void 0&&this._$El!==s){const i=a.getPropertyOptions(s),c=typeof i.converter=="function"?{fromAttribute:i.converter}:((o=i.converter)===null||o===void 0?void 0:o.fromAttribute)!==void 0?i.converter:ar;this._$El=s,this[s]=c.fromAttribute(e,i.type),this._$El=null}}requestUpdate(t,e,o){let a=!0;t!==void 0&&(((o=o||this.constructor.getPropertyOptions(t)).hasChanged||yo)(this[t],e)?(this._$AL.has(t)||this._$AL.set(t,e),o.reflect===!0&&this._$El!==t&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(t,o))):a=!1),!this.isUpdatePending&&a&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(e){Promise.reject(e)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((a,s)=>this[s]=a),this._$Ei=void 0);let e=!1;const o=this._$AL;try{e=this.shouldUpdate(o),e?(this.willUpdate(o),(t=this._$ES)===null||t===void 0||t.forEach(a=>{var s;return(s=a.hostUpdate)===null||s===void 0?void 0:s.call(a)}),this.update(o)):this._$Ek()}catch(a){throw e=!1,this._$Ek(),a}e&&this._$AE(o)}willUpdate(t){}_$AE(t){var e;(e=this._$ES)===null||e===void 0||e.forEach(o=>{var a;return(a=o.hostUpdated)===null||a===void 0?void 0:a.call(o)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(t){return!0}update(t){this._$EC!==void 0&&(this._$EC.forEach((e,o)=>this._$EO(o,this[o],e)),this._$EC=void 0),this._$Ek()}updated(t){}firstUpdated(t){}}var cr;Ft.finalized=!0,Ft.elementProperties=new Map,Ft.elementStyles=[],Ft.shadowRootOptions={mode:"open"},fo==null||fo({ReactiveElement:Ft}),((sr=He.reactiveElementVersions)!==null&&sr!==void 0?sr:He.reactiveElementVersions=[]).push("1.6.1");const Ie=window,Vt=Ie.trustedTypes,ko=Vt?Vt.createPolicy("lit-html",{createHTML:r=>r}):void 0,nr="$lit$",At=`lit$${(Math.random()+"").slice(9)}$`,wo="?"+At,Ys=`<${wo}>`,Wt=document,ce=()=>Wt.createComment(""),ne=r=>r===null||typeof r!="object"&&typeof r!="function",xo=Array.isArray,lr=`[ 	
\f\r]`,le=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,zo=/-->/g,Co=/>/g,Pt=RegExp(`>|${lr}(?:([^\\s"'>=/]+)(${lr}*=${lr}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),jo=/'/g,Ao=/"/g,Eo=/^(?:script|style|textarea|title)$/i,Ho=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),u=Ho(1),Qs=Ho(2),ut=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),Io=new WeakMap,Gt=Wt.createTreeWalker(Wt,129,null,!1);class we{constructor({strings:t,_$litType$:e},o){let a;this.parts=[];let s=0,i=0;const c=t.length-1,n=this.parts,[l,p]=((d,g)=>{const h=d.length-1,b=[];let f,A=g===2?"<svg>":"",v=le;for(let j=0;j<h;j++){const w=d[j];let H,x,E=-1,B=0;for(;B<w.length&&(v.lastIndex=B,x=v.exec(w),x!==null);)B=v.lastIndex,v===le?x[1]==="!--"?v=zo:x[1]!==void 0?v=Co:x[2]!==void 0?(Eo.test(x[2])&&(f=RegExp("</"+x[2],"g")),v=Pt):x[3]!==void 0&&(v=Pt):v===Pt?x[0]===">"?(v=f!=null?f:le,E=-1):x[1]===void 0?E=-2:(E=v.lastIndex-x[2].length,H=x[1],v=x[3]===void 0?Pt:x[3]==='"'?Ao:jo):v===Ao||v===jo?v=Pt:v===zo||v===Co?v=le:(v=Pt,f=void 0);const M=v===Pt&&d[j+1].startsWith("/>")?" ":"";A+=v===le?w+Ys:E>=0?(b.push(H),w.slice(0,E)+nr+w.slice(E)+At+M):w+At+(E===-2?(b.push(void 0),j):M)}const C=A+(d[h]||"<?>")+(g===2?"</svg>":"");if(!Array.isArray(d)||!d.hasOwnProperty("raw"))throw Error("invalid template strings array");return[ko!==void 0?ko.createHTML(C):C,b]})(t,e);if(this.el=we.createElement(l,o),Gt.currentNode=this.el.content,e===2){const d=this.el.content,g=d.firstChild;g.remove(),d.append(...g.childNodes)}for(;(a=Gt.nextNode())!==null&&n.length<c;){if(a.nodeType===1){if(a.hasAttributes()){const d=[];for(const g of a.getAttributeNames())if(g.endsWith(nr)||g.startsWith(At)){const h=p[i++];if(d.push(g),h!==void 0){const b=a.getAttribute(h.toLowerCase()+nr).split(At),f=/([.?@])?(.*)/.exec(h);n.push({type:1,index:s,name:f[2],strings:b,ctor:f[1]==="."?ta:f[1]==="?"?ra:f[1]==="@"?oa:Se})}else n.push({type:6,index:s})}for(const g of d)a.removeAttribute(g)}if(Eo.test(a.tagName)){const d=a.textContent.split(At),g=d.length-1;if(g>0){a.textContent=Vt?Vt.emptyScript:"";for(let h=0;h<g;h++)a.append(d[h],ce()),Gt.nextNode(),n.push({type:2,index:++s});a.append(d[g],ce())}}}else if(a.nodeType===8)if(a.data===wo)n.push({type:2,index:s});else{let d=-1;for(;(d=a.data.indexOf(At,d+1))!==-1;)n.push({type:7,index:s}),d+=At.length-1}s++}}static createElement(t,e){const o=Wt.createElement("template");return o.innerHTML=t,o}}function Kt(r,t,e=r,o){var a,s,i,c;if(t===ut)return t;let n=o!==void 0?(a=e._$Co)===null||a===void 0?void 0:a[o]:e._$Cl;const l=ne(t)?void 0:t._$litDirective$;return(n==null?void 0:n.constructor)!==l&&((s=n==null?void 0:n._$AO)===null||s===void 0||s.call(n,!1),l===void 0?n=void 0:(n=new l(r),n._$AT(r,e,o)),o!==void 0?((i=(c=e)._$Co)!==null&&i!==void 0?i:c._$Co=[])[o]=n:e._$Cl=n),n!==void 0&&(t=Kt(r,n._$AS(r,t.values),n,o)),t}class Js{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:o},parts:a}=this._$AD,s=((e=t==null?void 0:t.creationScope)!==null&&e!==void 0?e:Wt).importNode(o,!0);Gt.currentNode=s;let i=Gt.nextNode(),c=0,n=0,l=a[0];for(;l!==void 0;){if(c===l.index){let p;l.type===2?p=new xe(i,i.nextSibling,this,t):l.type===1?p=new l.ctor(i,l.name,l.strings,this,t):l.type===6&&(p=new sa(i,this,t)),this._$AV.push(p),l=a[++n]}c!==(l==null?void 0:l.index)&&(i=Gt.nextNode(),c++)}return s}v(t){let e=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,e),e+=o.strings.length-2):o._$AI(t[e])),e++}}class xe{constructor(t,e,o,a){var s;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=o,this.options=a,this._$Cp=(s=a==null?void 0:a.isConnected)===null||s===void 0||s}get _$AU(){var t,e;return(e=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&e!==void 0?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return e!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Kt(this,t,e),ne(t)?t===$||t==null||t===""?(this._$AH!==$&&this._$AR(),this._$AH=$):t!==this._$AH&&t!==ut&&this._(t):t._$litType$!==void 0?this.g(t):t.nodeType!==void 0?this.$(t):(o=>xo(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function")(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==$&&ne(this._$AH)?this._$AA.nextSibling.data=t:this.$(Wt.createTextNode(t)),this._$AH=t}g(t){var e;const{values:o,_$litType$:a}=t,s=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=we.createElement(a.h,this.options)),a);if(((e=this._$AH)===null||e===void 0?void 0:e._$AD)===s)this._$AH.v(o);else{const i=new Js(s,this),c=i.u(this.options);i.v(o),this.$(c),this._$AH=i}}_$AC(t){let e=Io.get(t.strings);return e===void 0&&Io.set(t.strings,e=new we(t)),e}T(t){xo(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let o,a=0;for(const s of t)a===e.length?e.push(o=new xe(this.k(ce()),this.k(ce()),this,this.options)):o=e[a],o._$AI(s),a++;a<e.length&&(this._$AR(o&&o._$AB.nextSibling,a),e.length=a)}_$AR(t=this._$AA.nextSibling,e){var o;for((o=this._$AP)===null||o===void 0||o.call(this,!1,!0,e);t&&t!==this._$AB;){const a=t.nextSibling;t.remove(),t=a}}setConnected(t){var e;this._$AM===void 0&&(this._$Cp=t,(e=this._$AP)===null||e===void 0||e.call(this,t))}}class Se{constructor(t,e,o,a,s){this.type=1,this._$AH=$,this._$AN=void 0,this.element=t,this.name=e,this._$AM=a,this.options=s,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,o,a){const s=this.strings;let i=!1;if(s===void 0)t=Kt(this,t,e,0),i=!ne(t)||t!==this._$AH&&t!==ut,i&&(this._$AH=t);else{const c=t;let n,l;for(t=s[0],n=0;n<s.length-1;n++)l=Kt(this,c[o+n],e,n),l===ut&&(l=this._$AH[n]),i||(i=!ne(l)||l!==this._$AH[n]),l===$?t=$:t!==$&&(t+=(l!=null?l:"")+s[n+1]),this._$AH[n]=l}i&&!a&&this.j(t)}j(t){t===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t!=null?t:"")}}class ta extends Se{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===$?void 0:t}}const ea=Vt?Vt.emptyScript:"";class ra extends Se{constructor(){super(...arguments),this.type=4}j(t){t&&t!==$?this.element.setAttribute(this.name,ea):this.element.removeAttribute(this.name)}}class oa extends Se{constructor(t,e,o,a,s){super(t,e,o,a,s),this.type=5}_$AI(t,e=this){var o;if((t=(o=Kt(this,t,e,0))!==null&&o!==void 0?o:$)===ut)return;const a=this._$AH,s=t===$&&a!==$||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,i=t!==$&&(a===$||s);s&&this.element.removeEventListener(this.name,this,a),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,o;typeof this._$AH=="function"?this._$AH.call((o=(e=this.options)===null||e===void 0?void 0:e.host)!==null&&o!==void 0?o:this.element,t):this._$AH.handleEvent(t)}}class sa{constructor(t,e,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){Kt(this,t)}}const So=Ie.litHtmlPolyfillSupport;So==null||So(we,xe),((cr=Ie.litHtmlVersions)!==null&&cr!==void 0?cr:Ie.litHtmlVersions=[]).push("2.7.2");const To=(r,t,e)=>{var o,a;const s=(o=e==null?void 0:e.renderBefore)!==null&&o!==void 0?o:t;let i=s._$litPart$;if(i===void 0){const c=(a=e==null?void 0:e.renderBefore)!==null&&a!==void 0?a:null;s._$litPart$=i=new xe(t.insertBefore(ce(),c),c,void 0,e!=null?e:{})}return i._$AI(r),i};var ur,mr;class ct extends Ft{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const o=super.createRenderRoot();return(t=(e=this.renderOptions).renderBefore)!==null&&t!==void 0||(e.renderBefore=o.firstChild),o}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=To(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)===null||t===void 0||t.setConnected(!1)}render(){return ut}}ct.finalized=!0,ct._$litElement$=!0,(ur=globalThis.litElementHydrateSupport)===null||ur===void 0||ur.call(globalThis,{LitElement:ct});const Lo=globalThis.litElementPolyfillSupport;Lo==null||Lo({LitElement:ct}),((mr=globalThis.litElementVersions)!==null&&mr!==void 0?mr:globalThis.litElementVersions=[]).push("3.3.1");const pr=new Set,aa=new MutationObserver(()=>{const r=document.documentElement.dir==="rtl"?document.documentElement.dir:"ltr";pr.forEach(t=>{t.setAttribute("dir",r)})});aa.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]});const ia=r=>r.startManagingContentDirection!==void 0||r.tagName==="SP-THEME";class R extends function(t){return class extends t{get isLTR(){return this.dir==="ltr"}hasVisibleFocusInTree(){const e=this.getRootNode().activeElement;if(!e)return!1;try{return e.matches(":focus-visible")||e.matches(".focus-visible")}catch(o){return e.matches(".focus-visible")}}connectedCallback(){if(!this.hasAttribute("dir")){let e=this.assignedSlot||this.parentNode;for(;e!==document.documentElement&&!ia(e);)e=e.assignedSlot||e.parentNode||e.host;if(this.dir=e.dir==="rtl"?e.dir:this.dir||"ltr",e===document.documentElement)pr.add(this);else{const{localName:o}=e;o.search("-")>-1&&!customElements.get(o)?customElements.whenDefined(o).then(()=>{e.startManagingContentDirection(this)}):e.startManagingContentDirection(this)}this._dirParent=e}super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._dirParent&&(this._dirParent===document.documentElement?pr.delete(this):this._dirParent.stopManagingContentDirection(this),this.removeAttribute("dir"))}}}(ct){}const ca=(r,t)=>t.kind==="method"&&t.descriptor&&!("value"in t.descriptor)?{...t,finisher(e){e.createProperty(t.key,r)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:t.key,initializer(){typeof t.initializer=="function"&&(this[t.key]=t.initializer.call(this))},finisher(e){e.createProperty(t.key,r)}};function m(r){return(t,e)=>e!==void 0?((o,a,s)=>{a.constructor.createProperty(s,o)})(r,t,e):ca(r,t)}function dr(r){return m({...r,state:!0})}const gr=({finisher:r,descriptor:t})=>(e,o)=>{var a;if(o===void 0){const s=(a=e.originalKey)!==null&&a!==void 0?a:e.key,i=t!=null?{kind:"method",placement:"prototype",key:s,descriptor:t(e.key)}:{...e,key:s};return r!=null&&(i.finisher=function(c){r(c,s)}),i}{const s=e.constructor;t!==void 0&&Object.defineProperty(e,o,t(o)),r==null||r(s,o)}};function tt(r,t){return gr({descriptor:e=>{const o={get(){var a,s;return(s=(a=this.renderRoot)===null||a===void 0?void 0:a.querySelector(r))!==null&&s!==void 0?s:null},enumerable:!0,configurable:!0};if(t){const a=typeof e=="symbol"?Symbol():"__"+e;o.get=function(){var s,i;return this[a]===void 0&&(this[a]=(i=(s=this.renderRoot)===null||s===void 0?void 0:s.querySelector(r))!==null&&i!==void 0?i:null),this[a]}}return o}})}var hr;const na=((hr=window.HTMLSlotElement)===null||hr===void 0?void 0:hr.prototype.assignedElements)!=null?(r,t)=>r.assignedElements(t):(r,t)=>r.assignedNodes(t).filter(e=>e.nodeType===Node.ELEMENT_NODE);function Do(r,t,e){let o,a=r;return typeof r=="object"?(a=r.slot,o=r):o={flatten:t},e?function(s){const{slot:i,selector:c}=s!=null?s:{};return gr({descriptor:n=>({get(){var l;const p="slot"+(i?`[name=${i}]`:":not([name])"),d=(l=this.renderRoot)===null||l===void 0?void 0:l.querySelector(p),g=d!=null?na(d,s):[];return c?g.filter(h=>h.matches(c)):g},enumerable:!0,configurable:!0})})}({slot:a,flatten:t,selector:e}):gr({descriptor:s=>({get(){var i,c;const n="slot"+(a?`[name=${a}]`:":not([name])"),l=(i=this.renderRoot)===null||i===void 0?void 0:i.querySelector(n);return(c=l==null?void 0:l.assignedNodes(o))!==null&&c!==void 0?c:[]},enumerable:!0,configurable:!0})})}var la=Object.defineProperty,ua=Object.getOwnPropertyDescriptor;function nt(r,{validSizes:t=["s","m","l","xl"],noDefaultSize:e,defaultSize:o="m"}={}){class a extends r{constructor(){super(...arguments),this._size=o}get size(){return this._size||o}set size(i){const c=e?null:o,n=i&&i.toLocaleLowerCase(),l=t.includes(n)?n:c;if(l&&this.setAttribute("size",l),this._size===l)return;const p=this._size;this._size=l,this.requestUpdate("size",p)}update(i){!this.hasAttribute("size")&&!e&&this.setAttribute("size",this.size),super.update(i)}}return((s,i,c,n)=>{for(var l,p=n>1?void 0:n?ua(i,c):i,d=s.length-1;d>=0;d--)(l=s[d])&&(p=(n?l(i,c,p):l(p))||p);n&&p&&la(i,c,p)})([m({type:String,reflect:!0})],a.prototype,"size",1),a}const ma=["spectrum","express"],pa=["medium","large","medium-express","large-express"],da=["light","lightest","dark","darkest","light-express","lightest-express","dark-express","darkest-express"],G=class extends HTMLElement{constructor(){super(),this._dir="",this._theme="spectrum",this._color="",this._scale="",this.trackedChildren=new Set,this._updateRequested=!1,this._contextConsumers=new Map,this.attachShadow({mode:"open"});const r=document.importNode(G.template.content,!0);this.shadowRoot.appendChild(r),this.shouldAdoptStyles(),this.addEventListener("sp-query-theme",this.onQueryTheme),this.addEventListener("sp-language-context",this._handleContextPresence),this.updateComplete=this.__createDeferredPromise()}static get observedAttributes(){return["color","scale","theme","lang","dir"]}set dir(r){if(r===this.dir)return;this.setAttribute("dir",r),this._dir=r;const t=r==="rtl"?r:"ltr";this.trackedChildren.forEach(e=>{e.setAttribute("dir",t)})}get dir(){return this._dir}attributeChangedCallback(r,t,e){t!==e&&(r==="color"?this.color=e:r==="scale"?this.scale=e:r==="lang"&&e?(this.lang=e,this._provideContext()):r==="theme"?this.theme=e:r==="dir"&&(this.dir=e))}requestUpdate(){window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow?this.shouldAdoptStyles():window.ShadyCSS.styleElement(this)}get theme(){const r=G.themeFragmentsByKind.get("theme"),{name:t}=r&&r.get("default")||{};return this._theme||t||""}set theme(r){if(r===this._theme)return;const t=r&&ma.includes(r)?r:this.theme;t!==this._theme&&(this._theme=t,this.requestUpdate()),t?this.setAttribute("theme",t):this.removeAttribute("theme")}get color(){const r=G.themeFragmentsByKind.get("color"),{name:t}=r&&r.get("default")||{};return this._color||t||""}set color(r){if(r===this._color)return;const t=r&&da.includes(r)?r:this.color;t!==this._color&&(this._color=t,this.requestUpdate()),t?this.setAttribute("color",t):this.removeAttribute("color")}get scale(){const r=G.themeFragmentsByKind.get("scale"),{name:t}=r&&r.get("default")||{};return this._scale||t||""}set scale(r){if(r===this._scale)return;const t=r&&pa.includes(r)?r:this.scale;t!==this._scale&&(this._scale=t,this.requestUpdate()),t?this.setAttribute("scale",t):this.removeAttribute("scale")}get styles(){const r=[...G.themeFragmentsByKind.keys()],t=(e,o,a)=>{const s=a&&a!=="theme"&&this.theme==="express"?e.get(`${o}-express`):e.get(o),i=o==="spectrum"||!a||this.hasAttribute(a);if(s&&i)return s.styles};return[...r.reduce((e,o)=>{const a=G.themeFragmentsByKind.get(o);let s;if(o==="app"||o==="core")s=t(a,o);else{const{[o]:i}=this;s=t(a,i,o)}return s&&e.push(s),e},[])]}static get template(){return this.templateElement||(this.templateElement=document.createElement("template"),this.templateElement.innerHTML="<slot></slot>"),this.templateElement}__createDeferredPromise(){return new Promise(r=>{this.__resolve=r})}onQueryTheme(r){if(r.defaultPrevented)return;r.preventDefault();const{detail:t}=r;t.color=this.color||void 0,t.scale=this.scale||void 0,t.lang=this.lang||document.documentElement.lang||navigator.language,t.theme=this.theme||void 0}connectedCallback(){if(this.shouldAdoptStyles(),window.ShadyCSS!==void 0&&window.ShadyCSS.styleElement(this),G.instances.add(this),!this.hasAttribute("dir")){let r=this.assignedSlot||this.parentNode;for(;r!==document.documentElement&&!(r instanceof G);)r=r.assignedSlot||r.parentNode||r.host;this.dir=r.dir==="rtl"?r.dir:"ltr"}}disconnectedCallback(){G.instances.delete(this)}startManagingContentDirection(r){this.trackedChildren.add(r)}stopManagingContentDirection(r){this.trackedChildren.delete(r)}async shouldAdoptStyles(){this._updateRequested||(this.updateComplete=this.__createDeferredPromise(),this._updateRequested=!0,this._updateRequested=await!1,this.adoptStyles(),this.__resolve(!0))}adoptStyles(){const r=this.styles;if(window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow&&window.ShadyCSS.ScopingShim){const t=[];for(const[e,o]of G.themeFragmentsByKind)for(const[a,{styles:s}]of o){if(a==="default")continue;let i=s.cssText;G.defaultFragments.has(a)||(i=i.replace(":host",`:host([${e}='${a}'])`)),t.push(i)}window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t,this.localName),window.ShadyCSS.prepareTemplate(G.template,this.localName)}else if(Ee){const t=[];for(const e of r)t.push(e.styleSheet);this.shadowRoot.adoptedStyleSheets=t}else this.shadowRoot.querySelectorAll("style").forEach(t=>t.remove()),r.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.shadowRoot.appendChild(e)})}static registerThemeFragment(r,t,e){const o=G.themeFragmentsByKind.get(t)||new Map;o.size===0&&(G.themeFragmentsByKind.set(t,o),o.set("default",{name:r,styles:e}),G.defaultFragments.add(r)),o.set(r,{name:r,styles:e}),G.instances.forEach(a=>a.shouldAdoptStyles())}_provideContext(){this._contextConsumers.forEach(([r,t])=>r(this.lang,t))}_handleContextPresence(r){r.stopPropagation();const t=r.composedPath()[0];if(this._contextConsumers.has(t))return;this._contextConsumers.set(t,[r.detail.callback,()=>this._contextConsumers.delete(t)]);const[e,o]=this._contextConsumers.get(t)||[];e&&o&&e(this.lang||document.documentElement.lang||navigator.language,o)}};let Et=G;Et.themeFragmentsByKind=new Map,Et.defaultFragments=new Set(["spectrum"]),Et.instances=new Set,customElements.define("sp-theme",Et);var ga=k`
...
`;Et.registerThemeFragment("spectrum","theme",ha),Et.registerThemeFragment("dark","color",ga);var ba=k`
...
`;Et.registerThemeFragment("light","color",ba);var va=k`
...
`;const vr=r=>r.querySelector('button:not([tabindex="-1"]), [href]:not([tabindex="-1"]), input:not([tabindex="-1"]), select:not([tabindex="-1"]), textarea:not([tabindex="-1"]), [tabindex]:not([tabindex="-1"]), [focusable]:not([tabindex="-1"])');let fr=!0;try{document.body.querySelector(":focus-visible")}catch(r){fr=!1,import("./focus-visible.js")}const qo=r=>{var t;const e=Symbol("endPolyfillCoordination");return t=e,class extends r{constructor(){super(...arguments),this[t]=null}connectedCallback(){super.connectedCallback&&super.connectedCallback(),fr||requestAnimationFrame(()=>{this[e]==null&&(this[e]=(o=>{if(o.shadowRoot==null||o.hasAttribute("data-js-focus-visible"))return()=>{};if(!self.applyFocusVisiblePolyfill){const a=()=>{self.applyFocusVisiblePolyfill&&o.shadowRoot&&self.applyFocusVisiblePolyfill(o.shadowRoot),o.manageAutoFocus&&o.manageAutoFocus()};return self.addEventListener("focus-visible-polyfill-ready",a,{once:!0}),()=>{self.removeEventListener("focus-visible-polyfill-ready",a)}}return self.applyFocusVisiblePolyfill(o.shadowRoot),o.manageAutoFocus&&o.manageAutoFocus(),()=>{}})(this))})}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),fr||requestAnimationFrame(()=>{this[e]!=null&&(this[e](),this[e]=null)})}}};var ka=Object.defineProperty,wa=Object.getOwnPropertyDescriptor,yr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?wa(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&ka(t,e,s),s};function Bo(){return new Promise(r=>requestAnimationFrame(()=>r()))}class vt extends qo(R){constructor(){super(...arguments),this.disabled=!1,this.autofocus=!1,this._tabIndex=-1,this.manipulatingTabindex=!1,this._recentlyConnected=!1}get tabIndex(){if(this.focusElement===this){const e=this.hasAttribute("tabindex")?Number(this.getAttribute("tabindex")):NaN;return isNaN(e)?-1:e}const t=parseFloat(this.hasAttribute("tabindex")&&this.getAttribute("tabindex")||"0");return this.disabled||t<0?-1:this.focusElement?this.focusElement.tabIndex:t}set tabIndex(t){if(this.manipulatingTabindex)this.manipulatingTabindex=!1;else if(this.focusElement!==this){if(t===-1?this.addEventListener("pointerdown",this.onPointerdownManagementOfTabIndex):(this.manipulatingTabindex=!0,this.removeEventListener("pointerdown",this.onPointerdownManagementOfTabIndex)),t===-1||this.disabled)return this.setAttribute("tabindex","-1"),this.removeAttribute("focusable"),void(t!==-1&&this.manageFocusElementTabindex(t));this.setAttribute("focusable",""),this.hasAttribute("tabindex")?this.removeAttribute("tabindex"):this.manipulatingTabindex=!1,this.manageFocusElementTabindex(t)}else if(t!==this._tabIndex){this._tabIndex=t;const e=this.disabled?"-1":""+t;this.manipulatingTabindex=!0,this.setAttribute("tabindex",e)}}onPointerdownManagementOfTabIndex(){this.tabIndex===-1&&(this.tabIndex=0,this.focus({preventScroll:!0}))}async manageFocusElementTabindex(t){this.focusElement||await this.updateComplete,t===null?this.focusElement.removeAttribute("tabindex"):this.focusElement.tabIndex=t}get focusElement(){throw new Error("Must implement focusElement getter!")}focus(t){this.disabled||!this.focusElement||(this.focusElement!==this?this.focusElement.focus(t):HTMLElement.prototype.focus.apply(this,[t]))}blur(){const t=this.focusElement||this;t!==this?t.blur():HTMLElement.prototype.blur.apply(this)}click(){if(this.disabled)return;const t=this.focusElement||this;t!==this?t.click():HTMLElement.prototype.click.apply(this)}manageAutoFocus(){this.autofocus&&(this.dispatchEvent(new KeyboardEvent("keydown",{code:"Tab"})),this.focusElement.focus())}firstUpdated(t){super.firstUpdated(t),(!this.hasAttribute("tabindex")||this.getAttribute("tabindex")!=="-1")&&this.setAttribute("focusable","")}update(t){t.has("disabled")&&this.handleDisabledChanged(this.disabled,t.get("disabled")),super.update(t)}updated(t){super.updated(t),t.has("disabled")&&this.disabled&&this.blur()}async handleDisabledChanged(t,e){const o=()=>this.focusElement!==this&&this.focusElement.disabled!==void 0;t?(this.manipulatingTabindex=!0,this.setAttribute("tabindex","-1"),await this.updateComplete,o()?this.focusElement.disabled=!0:this.setAttribute("aria-disabled","true")):e&&(this.manipulatingTabindex=!0,this.focusElement===this?this.setAttribute("tabindex",""+this._tabIndex):this.removeAttribute("tabindex"),await this.updateComplete,o()?this.focusElement.disabled=!1:this.removeAttribute("aria-disabled"))}async getUpdateComplete(){const t=await super.getUpdateComplete();return this._recentlyConnected&&(this._recentlyConnected=!1,await Bo(),await Bo()),t}connectedCallback(){super.connectedCallback(),this._recentlyConnected=!0,this.updateComplete.then(()=>{this.manageAutoFocus()})}}yr([m({type:Boolean,reflect:!0})],vt.prototype,"disabled",2),yr([m({type:Boolean})],vt.prototype,"autofocus",2),yr([m({type:Number})],vt.prototype,"tabIndex",1);const I=r=>r!=null?r:$,kr=1,xa=2,Po=3,Oo=4,Te=r=>(...t)=>({_$litDirective$:r,values:t});class wr{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,o){this._$Ct=t,this._$AM=e,this._$Ci=o}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Mo=r=>r.strings===void 0,za={},_o=Te(class extends wr{constructor(r){var t;if(super(r),r.type!==kr||r.name!=="class"||((t=r.strings)===null||t===void 0?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(t=>r[t]).join(" ")+" "}update(r,[t]){var e,o;if(this.it===void 0){this.it=new Set,r.strings!==void 0&&(this.nt=new Set(r.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!(!((e=this.nt)===null||e===void 0)&&e.has(s))&&this.it.add(s);return this.render(t)}const a=r.element.classList;this.it.forEach(s=>{s in t||(a.remove(s),this.it.delete(s))});for(const s in t){const i=!!t[s];i===this.it.has(s)||!((o=this.nt)===null||o===void 0)&&o.has(s)||(i?(a.add(s),this.it.add(s)):(a.remove(s),this.it.delete(s)))}return ut}}),ue=(r,t)=>{var e,o;const a=r._$AN;if(a===void 0)return!1;for(const s of a)(o=(e=s)._$AO)===null||o===void 0||o.call(e,t,!1),ue(s,t);return!0},Le=r=>{let t,e;do{if((t=r._$AM)===void 0)break;e=t._$AN,e.delete(r),r=t}while((e==null?void 0:e.size)===0)},Ro=r=>{for(let t;t=r._$AM;r=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(r))break;e.add(r),Aa(t)}};function Ca(r){this._$AN!==void 0?(Le(this),this._$AM=r,Ro(this)):this._$AM=r}function ja(r,t=!1,e=0){const o=this._$AH,a=this._$AN;if(a!==void 0&&a.size!==0)if(t)if(Array.isArray(o))for(let s=e;s<o.length;s++)ue(o[s],!1),Le(o[s]);else o!=null&&(ue(o,!1),Le(o));else ue(this,r)}const Aa=r=>{var t,e,o,a;r.type==xa&&((t=(o=r)._$AP)!==null&&t!==void 0||(o._$AP=ja),(e=(a=r)._$AQ)!==null&&e!==void 0||(a._$AQ=Ca))};class Uo extends wr{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,o){super._$AT(t,e,o),Ro(this),this.isConnected=t._$AU}_$AO(t,e=!0){var o,a;t!==this.isConnected&&(this.isConnected=t,t?(o=this.reconnected)===null||o===void 0||o.call(this):(a=this.disconnected)===null||a===void 0||a.call(this)),e&&(ue(this,t),Le(this))}setValue(t){if(Mo(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}const Ea=Te(class extends wr{constructor(r){if(super(r),r.type!==Po&&r.type!==kr&&r.type!==Oo)throw Error("The `live` directive is not allowed on child or event bindings");if(!Mo(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[t]){if(t===ut||t===$)return t;const e=r.element,o=r.name;if(r.type===Po){if(t===e[o])return ut}else if(r.type===Oo){if(!!t===e.hasAttribute(o))return ut}else if(r.type===kr&&e.getAttribute(o)===t+"")return ut;return((a,s=za)=>{a._$AH=s})(r),t}});var Ha=Object.defineProperty,Ia=Object.getOwnPropertyDescriptor,me=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ia(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ha(t,e,s),s};function De(r){class t extends r{renderAnchor({id:o,className:a,ariaHidden:s,labelledby:i,tabindex:c,anchorContent:n=u`<slot></slot>`}){return u`<a
                    id=${o}
                    class=${I(a)}
                    href=${I(this.href)}
                    ...
                    aria-labelledby=${I(i)}
                    aria-hidden=${I(s?"true":void 0)}
                    tabindex=${I(c)}
                    rel=${I(this.rel)}
                >${n}</a>`}}return me([m({reflect:!0})],t.prototype,"download",2),me([m()],t.prototype,"label",2),me([m({reflect:!0})],t.prototype,"href",2),me([m({reflect:!0})],t.prototype,"target",2),me([m({reflect:!0})],t.prototype,"rel",2),t}class $e{constructor(t,{target:e,config:o,callback:a,skipInitial:s}){this.t=new Set,this.o=!1,this.i=!1,this.h=t,e!==null&&this.t.add(e!=null?e:t),this.l=o,this.o=s!=null?s:this.o,this.callback=a,window.MutationObserver?(this.u=new MutationObserver(i=>{this.handleChanges(i),this.h.requestUpdate()}),t.addController(this)):console.warn("MutationController error: browser does not support MutationObserver.")}handleChanges(t){var e;this.value=(e=this.callback)===null||e===void 0?void 0:e.call(this,t,this.u)}hostConnected(){for(const t of this.t)this.observe(t)}hostDisconnected(){this.disconnect()}async hostUpdated(){const t=this.u.takeRecords();(t.length||!this.o&&this.i)&&this.handleChanges(t),this.i=!1}observe(t){this.t.add(t),this.u.observe(t,this.l),this.i=!0,this.h.requestUpdate()}disconnect(){this.u.disconnect()}}const Zt=Symbol("slotContentIsPresent");var Sa=Object.defineProperty,Ta=Object.getOwnPropertyDescriptor,No=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ta(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Sa(t,e,s),s};const xr=Symbol("assignedNodes");function zr(r){return typeof window<"u"&&window.navigator!=null&&r.test(window.navigator.platform)}function La(){return zr(/^iPad/)||zr(/^Mac/)&&navigator.maxTouchPoints>1}function Da(){return zr(/^iPhone/)||La()}function $a(){return function(r){return typeof window<"u"&&window.navigator!=null&&r.test(window.navigator.userAgent)}(/Android/)}const Cr=(r,t,{position:e,prepareCallback:o}={position:"beforeend"})=>{let{length:a}=r;if(a===0)return()=>r;let s=1,i=0;(e==="afterbegin"||e==="afterend")&&(s=-1,i=a-1);const c=new Array(a),n=new Array(a),l=document.createComment("placeholder for reparented element");do{const p=r[i];o&&(n[i]=o(p)),c[i]=l.cloneNode();const d=p.parentElement||p.getRootNode();d&&d!==p&&d.replaceChild(c[i],p),t.insertAdjacentElement(e,p),i+=s}while(--a>0);return function(){return function(p,d,g=[]){for(let h=0;h<d.length;++h){const b=d[h],f=p[h],A=f.parentElement||f.getRootNode();g[h]&&g[h](b),A&&A!==f&&A.replaceChild(b,f),delete p[h]}return d}(c,r,n)}};var Fo=k`
...
`,qa=Object.defineProperty,Ba=Object.getOwnPropertyDescriptor,jr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ba(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&qa(t,e,s),s};const Ar=class extends De(vt){constructor(){super(...arguments),this.value=void 0,this.selected=!1,this.expanded=!1}static get styles(){return[Fo]}get parentSideNav(){return this._parentSidenav||(this._parentSidenav=this.closest("sp-sidenav")),this._parentSidenav}get hasChildren(){return!!this.querySelector("sp-sidenav-item")}get depth(){let r=0,t=this.parentElement;for(;t instanceof Ar;)r++,t=t.parentElement;return r}handleSideNavSelect(r){this.selected=r.target===this}handleClick(r){!this.href&&r&&r.preventDefault(),!this.disabled&&(!this.href||r!=null&&r.defaultPrevented)&&(this.hasChildren?this.expanded=!this.expanded:this.value&&this.announceSelected(this.value))}announceSelected(r){const t=new CustomEvent("sidenav-select",{bubbles:!0,composed:!0,detail:{value:r}});this.dispatchEvent(t)}click(){this.handleClick()}get focusElement(){return this.shadowRoot.querySelector("#item-link")}update(r){this.hasAttribute("slot")||(this.slot="descendant"),super.update(r)}render(){return u`
            <a
                href=${this.href||"#"}
                target=${I(this.target)}
                download=${I(this.download)}
            ...
            ${this.expanded?u`
                  ...
                  `:u``}
        `}updated(r){this.hasChildren&&this.expanded&&!this.selected&&(this.focusElement.tabIndex=-1),super.updated(r)}connectedCallback(){super.connectedCallback(),this.startTrackingSelection()}disconnectedCallback(){this.stopTrackingSelection(),super.disconnectedCallback()}async startTrackingSelection(){const r=this.parentSideNav;if(r&&(await r.updateComplete,r.startTrackingSelectionForItem(this),this.selected=this.value!=null&&this.value===r.value,this.selected===!0&&r.variant==="multilevel")){let t=this.parentElement;for(;t instanceof Ar;)t.expanded=!0,t=t.parentElement}}stopTrackingSelection(){const r=this.parentSideNav;r&&r.stopTrackingSelectionForItem(this),this._parentSidenav=void 0}};let pe=Ar;jr([m()],pe.prototype,"value",2),jr([m({type:Boolean,reflect:!0})],pe.prototype,"selected",2),jr([m({type:Boolean,reflect:!0})],pe.prototype,"expanded",2);var Pa=k`
...
`,Oa=Object.defineProperty,Ma=Object.getOwnPropertyDescriptor;class Vo extends R{constructor(){super(...arguments),this.label=""}static get styles(){return[Fo,Pa]}update(t){this.hasAttribute("slot")||(this.slot="descendant"),super.update(t)}render(){return u`
            <h2 id="heading">${this.label}</h2>
            <div id="list" aria-labelledby="heading">
                <slot name="descendant"></slot>
            </div>
        `}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ma(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Oa(t,e,s)})([m({reflect:!0})],Vo.prototype,"label",2);var _a=Object.defineProperty,Ra=Object.getOwnPropertyDescriptor,Er=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ra(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&_a(t,e,s),s};class qe extends vt{constructor(){super(...arguments),this.items=new Set,this.rovingTabindexController=new $o(this,{focusInIndex:t=>t.findIndex(e=>this.value?!e.disabled&&!this.isDisabledChild(e)&&e.value===this.value:!e.disabled&&!this.isDisabledChild(e)),direction:"vertical",elements:()=>[...this.querySelectorAll("sp-sidenav-item")],isFocusableElement:t=>!t.disabled&&!this.isDisabledChild(t)}),this.manageTabIndex=!1,this.value=void 0,this.variant=void 0}static get styles(){return[ya]}startTrackingSelectionForItem(t){this.items.add(t),this.rovingTabindexController.clearElementCache()}stopTrackingSelectionForItem(t){this.items.delete(t),this.rovingTabindexController.clearElementCache()}handleSelect(t){if(t.stopPropagation(),this.value===t.detail.value)return;const e=this.value;this.value=t.detail.value,this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))?this.items.forEach(o=>o.handleSideNavSelect(t)):(this.value=e,t.target.selected=!1,t.preventDefault())}focus(){this.rovingTabindexController.focus()}blur(){this.focusElement!==this&&super.blur()}click(){this.focusElement!==this&&super.click()}get focusElement(){return this.rovingTabindexController.focusInElement||this}isDisabledChild(t){if(t.disabled)return!0;let e=t.parentElement;for(;e instanceof Vo||!e.disabled&&e instanceof pe&&e.expanded;)e=e.parentElement;return e!==this}handleSlotchange(){this.manageTabIndex?this.rovingTabindexController.manage():this.rovingTabindexController.unmanage()}render(){return u`
...
`,Ka=Object.defineProperty,Za=Object.getOwnPropertyDescriptor,Hr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Za(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ka(t,e,s),s};class Xt extends function(t,e){var o;class a extends t{constructor(...i){super(i),this.slotHasContent=!1,new $e(this,{config:{characterData:!0,subtree:!0},callback:c=>{for(const n of c)if(n.type==="characterData")return void this.manageTextObservedSlot()}})}manageTextObservedSlot(){if(!this[xr])return;const i=[...this[xr]].filter(c=>!!c.tagName||!!c.textContent&&c.textContent.trim());this.slotHasContent=i.length>0}update(i){if(!this.hasUpdated){const{childNodes:c}=this,n=[...c].filter(l=>l.tagName?e?l.getAttribute("slot")===e:!l.hasAttribute("slot"):!!l.textContent&&l.textContent.trim());this.slotHasContent=n.length>0}super.update(i)}firstUpdated(i){super.firstUpdated(i),this.updateComplete.then(()=>{this.manageTextObservedSlot()})}}return o=xr,No([m({type:Boolean,attribute:!1})],a.prototype,"slotHasContent",2),No([Do(e,!0)],a.prototype,o,2),a}(De(vt)){constructor(){super(),this.active=!1,this.type="button",this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0})}static get styles(){return[Ga]}get focusElement(){return this}get hasLabel(){return this.slotHasContent}get buttonContent(){return[u`
...
`,Ya=Object.defineProperty,Qa=Object.getOwnPropertyDescriptor,Be=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Qa(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ya(t,e,s),s};const Ja=["accent","primary","secondary","negative","white","black"];class de extends nt(Xt){constructor(){super(...arguments),this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,Xa]}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":return this.removeAttribute("variant"),this.static="white",void(this.treatment="outline");case"white":case"black":return this.static=t,void this.removeAttribute("variant");case null:return;default:Ja.includes(t)?this._variant=t:this._variant="accent"}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}}Be([m()],de.prototype,"variant",1),Be([m({type:String,reflect:!0})],de.prototype,"static",2),Be([m({reflect:!0})],de.prototype,"treatment",2),Be([m({type:Boolean})],de.prototype,"quiet",1);class Ko extends Xt{}var ti=k`
...
`,ri=Object.defineProperty,oi=Object.getOwnPropertyDescriptor,Zo=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?oi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&ri(t,e,s),s};class L extends R{static get styles(){return[ei]}render(){return u`
            <slot></slot>
        `}}Zo([m()],L.prototype,"label",2),Zo([m({reflect:!0})],L.prototype,"size",2);var si=Object.defineProperty,ai=Object.getOwnPropertyDescriptor,Ir=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ai(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&si(t,e,s),s};class Pe extends L{constructor(){super(...arguments),this.iconsetListener=t=>{if(!this.name)return;const e=this.parseIcon(this.name);t.detail.name===e.iconset&&(this.updateIconPromise=this.updateIcon())}}connectedCallback(){super.connectedCallback(),window.addEventListener("sp-iconset-added",this.iconsetListener)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("sp-iconset-added",this.iconsetListener)}firstUpdated(){this.updateIconPromise=this.updateIcon()}attributeChangedCallback(t,e,o){super.attributeChangedCallback(t,e,o),this.updateIconPromise=this.updateIcon()}render(){return this.name?u`
                <div id="container"></div>
            `:this.src?u`
                <img src="${this.src}" alt=${I(this.label)} />
            `:super.render()}async updateIcon(){if(this.updateIconPromise&&await this.updateIconPromise,!this.name)return Promise.resolve();const t=this.parseIcon(this.name),e=kt.getInstance().getIconset(t.iconset);return e&&this.iconContainer?(this.iconContainer.innerHTML="",e.applyIconToElement(this.iconContainer,t.icon,this.size||"",this.label?this.label:"")):Promise.resolve()}parseIcon(t){const e=t.split(":");let o="default",a=t;return e.length>1&&(o=e[0],a=e[1]),{iconset:o,icon:a}}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.updateIconPromise,t}}let Sr;Ir([m()],Pe.prototype,"src",2),Ir([m()],Pe.prototype,"name",2),Ir([tt("#container")],Pe.prototype,"iconContainer",2);const et=function(r,...t){return Sr?Sr(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},rt=r=>{Sr=r};y("sp-icon-cross75",class extends L{render(){return rt(u),(({width:r=24,height:t=24,title:e="Cross75"}={})=>et`<svg
...
`,ii=Object.defineProperty,ci=Object.getOwnPropertyDescriptor;const ni={s:()=>u`
        <sp-icon-cross75
            slot="icon"
    ...
    `,xl:()=>u`
        ...
        ></sp-icon-cross300>
    `};class Yo extends nt(Ko){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,ti,Xo]}get buttonContent(){return[ni[this.size]()]}render(){return u`
            <div class="fill">${super.render()}</div>
        `}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?ci(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&ii(t,e,s)})([m({reflect:!0})],Yo.prototype,"variant",2);var li=k`
...
`,ui=Object.defineProperty,mi=Object.getOwnPropertyDescriptor;const pi={s:()=>u`
        <sp-icon-cross75
            slot="icon"
            class="icon spectrum-UIIcon-Cross75"
        ></sp-icon-cross75>
    ...
    `,xl:()=>u`
        <sp-icon-cross300
            ...
            class="icon spectrum-UIIcon-Cross300"
        ></sp-icon-cross300>
    `};class Qo extends nt(Ko){constructor(){super(...arguments),this.variant=""}static get styles(){return[...super.styles,li,Xo]}get buttonContent(){return[pi[this.size]()]}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?mi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&ui(t,e,s)})([m({reflect:!0})],Qo.prototype,"variant",2);var di=k`
:host{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;align-items:center;-webkit-appearance:button;border-style:solid;box-sizing:border-box;cursor:pointer;display:inline-flex;font-family:var(
--mod-sans-font-family-stack,var(--spectrum-sans-font-family-stack)
);justify-content:center;line-height:var(--mod-line-height-100,var(--spectrum-line-height-100));margin:0;overflow:visible;-webkit-text-decoration:none;text-decoration:none;text-transform:none;transition:background var(
--mod-animation-duration-100,var(--spectrum-animation-duration-100)
...
`;y("sp-icon-corner-triangle300",class extends L{render(){return rt(u),(({width:r=24,height:t=24,title:e="Corner Triangle300"}={})=>et`<svg
  ...
  >
    ...
    />
  </svg>`)()}});var hi=Object.defineProperty,bi=Object.getOwnPropertyDescriptor,Ht=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?bi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&hi(t,e,s),s};const vi={xs:"spectrum-UIIcon-CornerTriangle75",s:"spectrum-UIIcon-CornerTriangle75",m:"spectrum-UIIcon-CornerTriangle100",l:"spectrum-UIIcon-CornerTriangle200",xl:"spectrum-UIIcon-CornerTriangle300"};let Jo;class zt extends nt(Xt,{validSizes:["xs","s","m","l","xl"]}){constructor(){super(),this.emphasized=!1,this.holdAffordance=!1,this.quiet=!1,this.role="button",this.selected=!1,this.toggles=!1,this._value="",this.onClick=()=>{this.toggles&&(this.selected=!this.selected,this.dispatchEvent(new Event("change",{cancelable:!0}))||(this.selected=!this.selected))},this.addEventListener("click",this.onClick),this.addEventListener("pointerdown",this.onPointerdown)}static get styles(){return[...super.styles,di,gi]}get value(){return this._value||this.itemText}set value(t){t!==this._value&&(this._value=t||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return(this.textContent||"").trim()}onPointerdown(t){t.button===0&&(this.addEventListener("pointerup",this.onPointerup),this.addEventListener("pointercancel",this.onPointerup),Jo=setTimeout(()=>{this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"pointer"}}))},300))}onPointerup(){clearTimeout(Jo),this.removeEventListener("pointerup",this.onPointerup),this.removeEventListener("pointercancel",this.onPointerup)}handleKeydown(t){if(!this.holdAffordance)return super.handleKeydown(t);const{code:e,altKey:o}=t;(e==="Space"||o&&e==="ArrowDown")&&(t.preventDefault(),e==="ArrowDown"&&(t.stopPropagation(),t.stopImmediatePropagation()),this.addEventListener("keyup",this.handleKeyup),this.active=!0)}handleKeyup(t){if(!this.holdAffordance)return super.handleKeyup(t);const{code:e,altKey:o}=t;(e==="Space"||o&&e==="ArrowDown")&&(t.stopPropagation(),this.dispatchEvent(new CustomEvent("longpress",{bubbles:!0,composed:!0,detail:{source:"keyboard"}})),this.active=!1)}get buttonContent(){const t=super.buttonContent;return this.holdAffordance&&t.unshift(u`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${vi[this.size]}"
                ></sp-icon-corner-triangle300>
            `),t}updated(t){super.updated(t);const e=this.role==="button"&&(this.selected||this.toggles);(t.has("selected")||t.has("role"))&&(e?this.setAttribute("aria-pressed",this.selected?"true":"false"):this.removeAttribute("aria-pressed"))}}Ht([m({type:Boolean,reflect:!0})],zt.prototype,"emphasized",2),Ht([m({type:Boolean,reflect:!0,attribute:"hold-affordance"})],zt.prototype,"holdAffordance",2),Ht([m({type:Boolean,reflect:!0})],zt.prototype,"quiet",2),Ht([m({reflect:!0})],zt.prototype,"role",2),Ht([m({type:Boolean,reflect:!0})],zt.prototype,"selected",2),Ht([m({type:Boolean,reflect:!0})],zt.prototype,"toggles",2),Ht([m({reflect:!0})],zt.prototype,"variant",2),Ht([m({type:String})],zt.prototype,"value",1),y("sp-action-button",zt);const ts=class{constructor(r,{mode:t}={mode:"internal"}){this.mode="internal",this.handleSlotchange=({target:e})=>{this.handleHelpText(e),this.handleNegativeHelpText(e)},this.host=r,this.instanceCount=ts.instanceCount++,this.id=`sp-help-text-${this.instanceCount}`,this.mode=t}get isInternal(){return this.mode==="internal"}render(r){return u`
        ...
        `}addId(){const r=this.helpTextElement?this.helpTextElement.id:this.id;this.conditionId=function(t,e,o){const a=Array.isArray(o)?o:[o],s=t.getAttribute(e),i=s?s.split(/\s+/):[];return a.every(c=>i.indexOf(c)>-1)?()=>{}:(i.push(...a),t.setAttribute(e,i.join(" ")),()=>function(c,n,l){const p=c.getAttribute(n);let d=p?p.split(/\s+/):[];d=d.filter(g=>!l.find(h=>g===h)),d.length?c.setAttribute(n,d.join(" ")):c.removeAttribute(n)}(t,e,a))}(this.host,"aria-describedby",r),this.host.hasAttribute("tabindex")&&(this.previousTabindex=parseFloat(this.host.getAttribute("tabindex"))),this.host.tabIndex=0}removeId(){this.conditionId&&(this.conditionId(),delete this.conditionId),!this.helpTextElement&&(this.previousTabindex?this.host.tabIndex=this.previousTabindex:this.host.removeAttribute("tabindex"))}handleHelpText(r){if(this.isInternal)return;this.helpTextElement&&this.helpTextElement.id===this.id&&this.helpTextElement.removeAttribute("id"),this.removeId();const t=r.assignedElements()[0];this.helpTextElement=t,t&&(t.id||(t.id=this.id),this.addId())}handleNegativeHelpText(r){r.name==="negative-help-text"&&r.assignedElements().forEach(t=>t.variant="negative")}};let es=ts;es.instanceCount=0;let Tr;y("sp-icon-checkmark100",class extends L{render(){return rt(u),(({width:r=24,height:t=24,title:e="Checkmark100"}={})=>et`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
  ...
  >
    ...
    />
  </svg>`)()}});const K=function(r,...t){return Tr?Tr(r,...t):t.reduce((e,o,a)=>e+o+r[a+1],r[0])},Z=r=>{Tr=r};y("sp-icon-alert",class extends L{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Alert"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});var fi=k`
...
`,yi=Object.defineProperty,ki=Object.getOwnPropertyDescriptor,U=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ki(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&yi(t,e,s),s};const wi=["text","url","tel","email","password"];class N extends function(t,{mode:e}={mode:"internal"}){return class extends t{constructor(){super(...arguments),this.helpTextManager=new es(this,{mode:e})}get helpTextId(){return this.helpTextManager.id}renderHelpText(o){return this.helpTextManager.render(o)}}}(vt){constructor(){super(...arguments),this.allowedKeys="",this.focused=!1,this.invalid=!1,this.label="",this.placeholder="",this._type="text",this.grows=!1,this.maxlength=-1,this.minlength=-1,this.multiline=!1,this.readonly=!1,this.valid=!1,this._value="",this.quiet=!1,this.required=!1}static get styles(){return[fi,Lr]}get type(){var t;return(t=wi.find(e=>e===this._type))!=null?t:"text"}set type(t){const e=this._type;this._type=t,this.requestUpdate("type",e)}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}get focusElement(){return this.inputElement}setSelectionRange(t,e,o="none"){this.inputElement.setSelectionRange(t,e,o)}select(){this.inputElement.select()}handleInput(){if(this.allowedKeys&&this.inputElement.value&&!new RegExp(`^[${this.allowedKeys}]*$`,"u").test(this.inputElement.value)){const t=this.inputElement.selectionStart-1;return this.inputElement.value=this.value.toString(),void this.inputElement.setSelectionRange(t,t)}this.value=this.inputElement.value}handleChange(){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))}onFocus(){this.focused=!this.readonly&&!0}onBlur(){this.focused=!this.readonly&&!1}renderStateIcons(){return this.invalid?u`
        ...
        `}update(t){(t.has("value")||t.has("required")&&this.required)&&this.updateComplete.then(()=>{this.checkValidity()}),super.update(t)}checkValidity(){let t=this.inputElement.checkValidity();return(this.required||this.value&&this.pattern)&&((this.disabled||this.multiline)&&this.pattern&&(t=new RegExp(`^${this.pattern}$`,"u").test(this.value.toString())),this.minlength!==void 0&&(t=t&&this.value.toString().length>=this.minlength),this.valid=t,this.invalid=!t),t}}U([m({attribute:"allowed-keys"})],N.prototype,"allowedKeys",2),U([m({type:Boolean,reflect:!0})],N.prototype,"focused",2),U([tt(".input")],N.prototype,"inputElement",2),U([m({type:Boolean,reflect:!0})],N.prototype,"invalid",2),U([m()],N.prototype,"label",2),U([m()],N.prototype,"placeholder",2),U([m({attribute:"type",reflect:!0})],N.prototype,"_type",2),U([dr()],N.prototype,"type",1),U([m()],N.prototype,"pattern",2),U([m({type:Boolean,reflect:!0})],N.prototype,"grows",2),U([m({type:Number})],N.prototype,"maxlength",2),U([m({type:Number})],N.prototype,"minlength",2),U([m({type:Boolean,reflect:!0})],N.prototype,"multiline",2),U([m({type:Boolean,reflect:!0})],N.prototype,"readonly",2),U([m({type:Boolean,reflect:!0})],N.prototype,"valid",2),U([m({type:String})],N.prototype,"value",1),U([m({type:Boolean,reflect:!0})],N.prototype,"quiet",2),U([m({type:Boolean,reflect:!0})],N.prototype,"required",2),U([m({type:String,reflect:!0})],N.prototype,"autocomplete",2);class Dr extends N{constructor(){super(...arguments),this._value=""}set value(t){if(t===this.value)return;const e=this._value;this._value=t,this.requestUpdate("value",e)}get value(){return this._value}}U([m({type:String})],Dr.prototype,"value",1),y("sp-clear-button",Yo),y("sp-icon-magnify",class extends L{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Magnify"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});var xi=k`
...
`,zi=Object.defineProperty,Ci=Object.getOwnPropertyDescriptor,ge=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ci(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&zi(t,e,s),s};const ji=r=>r.stopPropagation();class Yt extends Dr{constructor(){super(...arguments),this.action="",this.label="Search",this.placeholder="Search"}static get styles(){return[...super.styles,xi]}handleSubmit(t){this.dispatchEvent(new Event("submit",{cancelable:!0,bubbles:!0}))||t.preventDefault()}handleKeydown(t){const{code:e}=t;!this.value||e!=="Escape"||this.reset()}async reset(){this.value="",await this.updateComplete,this.focusElement.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0})),this.focusElement.dispatchEvent(new InputEvent("change",{bubbles:!0}))}renderField(){return u`
            <form
                action=${this.action}
                id="form"
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.inputElement.setAttribute("type","search")}willUpdate(){this.multiline=!1}}ge([m()],Yt.prototype,"action",2),ge([m()],Yt.prototype,"label",2),ge([m()],Yt.prototype,"method",2),ge([m()],Yt.prototype,"placeholder",2),ge([tt("#form")],Yt.prototype,"form",2),y("sp-search",Yt);var rs=k`
...
`,Ai=Object.defineProperty,Ei=Object.getOwnPropertyDescriptor;class $r extends nt(R,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.vertical=!1}render(){return u``}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}updated(t){super.updated(t),t.has("vertical")&&(this.vertical?this.setAttribute("aria-orientation","vertical"):this.removeAttribute("aria-orientation"))}}$r.styles=[rs],((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ei(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Ai(t,e,s)})([m({type:Boolean,reflect:!0})],$r.prototype,"vertical",2),y("sp-divider",$r),y("sp-close-button",Qo),y("sp-icon-info",class extends L{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Info"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}});var Hi=k`
...
`,Ii=Object.defineProperty,Si=Object.getOwnPropertyDescriptor,qr=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Si(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ii(t,e,s),s};const Ti=["negative","positive","info","error","warning"];class Oe extends R{constructor(){super(...arguments),this.open=!1,this._timeout=null,this._variant="",this.countdownStart=0,this.nextCount=-1,this.doCountdown=t=>{this.countdownStart||(this.countdownStart=performance.now()),t-this.countdownStart>this._timeout?(this.shouldClose(),this.countdownStart=0):this.countdown()},this.countdown=()=>{cancelAnimationFrame(this.nextCount),this.nextCount=requestAnimationFrame(this.doCountdown)},this.holdCountdown=()=>{this.stopCountdown(),this.addEventListener("focusout",this.resumeCountdown)},this.resumeCountdown=()=>{this.removeEventListener("focusout",this.holdCountdown),this.countdown()}}static get styles(){return[Hi]}set timeout(t){const e=typeof t!==null&&t>0?Math.max(6e3,t):null,o=this.timeout;e&&this.countdownStart&&(this.countdownStart=performance.now()),this._timeout=e,this.requestUpdate("timeout",o)}get timeout(){return this._timeout}set variant(t){if(t===this.variant)return;const e=this.variant;Ti.includes(t)?(this.setAttribute("variant",t),this._variant=t):(this.removeAttribute("variant"),this._variant=""),this.requestUpdate("variant",e)}get variant(){return this._variant}renderIcon(t){switch(t){case"info":return u`
                    <sp-icon-info
                        label="Information"
                        class="type"
                    ></sp-icon-info>
        ...
        `}updated(t){super.updated(t),t.has("open")&&(this.open?this.timeout&&this.startCountdown():this.timeout&&this.stopCountdown()),t.has("timeout")&&(this.timeout!==null&&this.open?this.startCountdown():this.stopCountdown())}}qr([m({type:Boolean,reflect:!0})],Oe.prototype,"open",2),qr([m({type:Number})],Oe.prototype,"timeout",1),qr([m({type:String})],Oe.prototype,"variant",1),y("sp-toast",Oe);const Me=async(r,t,e,o)=>{const{Overlay:a}=await Promise.resolve().then(function(){return Pc});return a.open(r,t,e,o)};var Li=k`
...
`,Ri=Object.defineProperty,Ui=Object.getOwnPropertyDescriptor,he=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Ui(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Ri(t,e,s),s};class te extends nt(R,{validSizes:["s","m","l"]}){constructor(){super(...arguments),this.indeterminate=!1,this.label="",this.overBackground=!1,this.progress=0}static get styles(){return[_i]}makeRotation(t){return this.indeterminate?void 0:`transform: rotate(${t}deg);`}willUpdate(t){t.has("overBackground")&&(this.static=this.overBackground?"white":this.static||void 0)}render(){const t=[this.makeRotation(3.6*Math.min(this.progress,50)-180),this.makeRotation(3.6*Math.max(this.progress-50,0)-180)];return u`
            <div class="track"></div>
            <div class="fills">
        ...
        `}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("role")||this.setAttribute("role","progressbar")}updated(t){super.updated(t),!this.indeterminate&&t.has("progress")?this.setAttribute("aria-valuenow",""+this.progress):this.hasAttribute("aria-valuenow")&&this.removeAttribute("aria-valuenow"),this.label&&t.has("label")&&this.setAttribute("aria-label",this.label)}}he([m({type:Boolean,reflect:!0})],te.prototype,"indeterminate",2),he([m({type:String})],te.prototype,"label",2),he([m({type:Boolean,reflect:!0,attribute:"over-background"})],te.prototype,"overBackground",2),he([m({reflect:!0})],te.prototype,"static",2),he([m({type:Number})],te.prototype,"progress",2),y("sp-progress-circle",te);var Ni=k`
...
`],Vi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,is=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Wi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Vi(t,e,s),s};class _e extends R{constructor(){super(...arguments),this.heading="",this.description=""}static get styles(){return[as,Fi,Ni]}render(){return u`
        ...
        `}}_e.is="sp-illustrated-message",is([m()],_e.prototype,"heading",2),is([m()],_e.prototype,"description",2),y("sp-illustrated-message",_e),y("sp-icon-search",class extends L{render(){return Z(u),(({width:r=24,height:t=24,hidden:e=!1,title:o="Search"}={})=>K`<svg
    xmlns="http://www.w3.org/2000/svg"
    height=${t}
    viewBox="0 0 36 36"
    width=${r}
  ...
  >
    ...
    />
  </svg>`)({hidden:!this.label,title:this.label})}}),y("sp-button",de);var Gi=k`
...
`,Ki=Object.defineProperty,Zi=Object.getOwnPropertyDescriptor;class cs extends nt(R){constructor(){super(...arguments),this.vertical=!1}static get styles(){return[Gi]}handleSlotchange({target:t}){t.assignedElements().forEach(e=>{e.size=this.size})}render(){return u`
            <slot @slotchange=${this.handleSlotchange}></slot>
        `}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?Zi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&Ki(t,e,s)})([m({type:Boolean,reflect:!0})],cs.prototype,"vertical",2),y("sp-button-group",cs);var Xi=k`
...
`,Yi=Object.defineProperty,Qi=Object.getOwnPropertyDescriptor,Tt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Qi(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Yi(t,e,s),s};const Or=[];class Ct extends nt(R,{validSizes:["xs","s","m","l","xl"]}){constructor(){super(),this._buttons=[],this._buttonSelector="sp-action-button",this.rovingTabindexController=new $o(this,{focusInIndex:t=>{let e=-1;const o=t.findIndex((a,s)=>(!t[e]&&!a.disabled&&(e=s),a.selected&&!a.disabled));return t[o]?o:e},elements:()=>this.buttons,isFocusableElement:t=>!t.disabled}),this.compact=!1,this.emphasized=!1,this.justified=!1,this.label="",this.quiet=!1,this.vertical=!1,this._selected=Or,this.manageButtons=()=>{const t=this.shadowRoot.querySelector("slot");if(!t)return;const e=t.assignedElements({flatten:!0}).reduce((a,s)=>{if(s.matches(this._buttonSelector))a.push(s);else{const i=Array.from(s.querySelectorAll(`:scope > ${this._buttonSelector}`));a.push(...i)}return a},[]);this.buttons=e;const o=[];this.buttons.forEach(a=>{a.selected&&o.push(a.value)}),this.setSelected(this.selected.concat(o)),this.manageChildren(),this.manageSelects()},new $e(this,{config:{childList:!0,subtree:!0},callback:()=>{this.manageButtons()}})}static get styles(){return[Xi]}set buttons(t){t!==this.buttons&&(this._buttons=t,this.rovingTabindexController.clearElementCache())}get buttons(){return this._buttons}set selected(t){this.requestUpdate("selected",this._selected),this._selected=t,this.updateComplete.then(()=>{this.applySelects(),this.manageChildren()})}get selected(){return this._selected}dispatchChange(t){this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0,cancelable:!0}))||(this.setSelected(t),this.buttons.map(e=>{e.selected=this.selected.includes(e.value)}))}setSelected(t,e){if(t===this.selected)return;const o=this.selected;this.requestUpdate("selected",o),this._selected=t,e&&this.dispatchChange(o)}focus(t){this.rovingTabindexController.focus(t)}deselectSelectedButtons(){[...this.querySelectorAll("[selected]")].forEach(t=>{t.selected=!1,t.tabIndex=-1,t.setAttribute("aria-checked","false")})}handleClick(t){const e=t.target;if(e.value!==void 0)switch(this.selects){case"single":this.deselectSelectedButtons(),e.selected=!0,e.tabIndex=0,e.setAttribute("aria-checked","true"),this.setSelected([e.value],!0),e.focus();break;case"multiple":{const o=[...this.selected];e.selected=!e.selected,e.setAttribute("aria-checked",e.selected?"true":"false"),e.selected?o.push(e.value):o.splice(this.selected.indexOf(e.value),1),this.setSelected(o,!0),this.buttons.forEach(a=>{a.tabIndex=-1}),e.tabIndex=0;break}}}async applySelects(){await this.manageSelects(!0)}async manageSelects(t){if(!this.buttons.length)return;const e=this.buttons;switch(this.selects){case"single":{this.setAttribute("role","radiogroup");const o=[],a=e.map(async i=>{await i.updateComplete,i.setAttribute("role","radio"),i.setAttribute("aria-checked",i.selected?"true":"false"),i.selected&&o.push(i)});if(t)break;await Promise.all(a);const s=o.map(i=>i.value);this.setSelected(s||Or);break}case"multiple":{this.setAttribute("role","group");const o=[],a=[],s=e.map(async c=>{await c.updateComplete,c.setAttribute("role","checkbox"),c.setAttribute("aria-checked",c.selected?"true":"false"),c.selected&&(o.push(c.value),a.push(c))});if(t)break;await Promise.all(s);const i=o.length?o:Or;this.setSelected(i);break}default:if(!this.selected.length){this.buttons.forEach(o=>{o.setAttribute("role","button")}),this.removeAttribute("role");break}{const o=[],a=e.map(async s=>{await s.updateComplete,s.setAttribute("aria-checked",s.selected?"true":"false"),s.setAttribute("role","button"),s.selected&&o.push(s)});if(t)break;await Promise.all(a),this.setSelected(o.map(s=>s.value))}}}render(){return u`
            <slot role="presentation" @slotchange=${this.manageButtons}></slot>
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("click",this.handleClick)}updated(t){super.updated(t),t.has("selects")&&(this.manageSelects(),this.manageChildren()),(t.has("quiet")&&this.quiet||t.has("emphasized")&&this.emphasized||t.has("size")&&this.size)&&this.manageChildren(),t.has("label")&&(this.label||t.get("label")!==void 0)&&(this.label.length?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"))}manageChildren(){this.buttons.forEach(t=>{t.quiet=this.quiet,t.emphasized=this.emphasized,t.selected=this.selected.includes(t.value),t.size=this.size})}}Tt([m({type:Boolean,reflect:!0})],Ct.prototype,"compact",2),Tt([m({type:Boolean,reflect:!0})],Ct.prototype,"emphasized",2),Tt([m({type:Boolean,reflect:!0})],Ct.prototype,"justified",2),Tt([m({type:String})],Ct.prototype,"label",2),Tt([m({type:Boolean,reflect:!0})],Ct.prototype,"quiet",2),Tt([m({type:String})],Ct.prototype,"selects",2),Tt([m({type:Boolean,reflect:!0})],Ct.prototype,"vertical",2),Tt([m({type:Array})],Ct.prototype,"selected",1),y("sp-action-group",Ct),y("sp-icon",Pe),y("sp-icon-chevron100",class extends L{render(){return rt(u),(({width:r=24,height:t=24,title:e="Chevron100"}={})=>et`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
...
`;class Ji extends Event{constructor({root:t}){super("sp-overlay-close",{bubbles:!0,composed:!0}),this.root=t}}var tc=k`
...
`,ec=Object.defineProperty,rc=Object.getOwnPropertyDescriptor,Lt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?rc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&ec(t,e,s),s};class oc extends Event{constructor(){super("sp-menu-item-removed",{bubbles:!0,composed:!0}),this.focused=!1}get item(){return this._item}reset(t){this._item=t}}class sc extends Event{constructor(){super("sp-menu-item-added-or-updated",{bubbles:!0,composed:!0})}set focusRoot(t){this.item.menuData.focusRoot=this.item.menuData.focusRoot||t}set selectionRoot(t){this.item.menuData.selectionRoot=this.item.menuData.selectionRoot||t}get item(){return this._item}set currentAncestorWithSelects(t){this._currentAncestorWithSelects=t}get currentAncestorWithSelects(){return this._currentAncestorWithSelects}reset(t){this._item=t,this._currentAncestorWithSelects=void 0,t.menuData={focusRoot:void 0,selectionRoot:void 0}}}const Re=new sc,ls=new oc,us=class extends De(vt){constructor(){super(),this.isInSubmenu=!1,this.active=!1,this.focused=!1,this.selected=!1,this._value="",this.hasSubmenu=!1,this.noWrap=!1,this.open=!1,this.handleSubmenuChange=()=>{var r;(r=this.menuData.selectionRoot)==null||r.selectOrToggleItem(this)},this.handleSubmenuPointerenter=()=>{this.leaveTimeout&&(clearTimeout(this.leaveTimeout),delete this.leaveTimeout)},this.menuData={focusRoot:void 0,selectionRoot:void 0},this.proxyFocus=this.proxyFocus.bind(this),this.addEventListener("click",this.handleClickCapture,{capture:!0}),new $e(this,{config:{characterData:!0,childList:!0,subtree:!0},callback:()=>{this.breakItemChildrenCache()}})}static get styles(){return[tc,Lr,ns]}get value(){return this._value||this.itemText}set value(r){r!==this._value&&(this._value=r||"",this._value?this.setAttribute("value",this._value):this.removeAttribute("value"))}get itemText(){return this.itemChildren.content.reduce((r,t)=>r+(t.textContent||"").trim(),"")}get focusElement(){return this}get itemChildren(){var r,t;if(this._itemChildren)return this._itemChildren;const e=(r=this.shadowRoot)==null?void 0:r.querySelector('slot[name="icon"]'),o=e?e.assignedElements().map(i=>{const c=i.cloneNode(!0);return c.removeAttribute("slot"),c.classList.toggle("icon"),c}):[],a=(t=this.shadowRoot)==null?void 0:t.querySelector("slot:not([name])"),s=a?a.assignedNodes().map(i=>i.cloneNode(!0)):[];return this._itemChildren={icon:o,content:s},this._itemChildren}click(){this.disabled||this.shouldProxyClick()||super.click()}handleClickCapture(r){if(this.disabled)return r.preventDefault(),r.stopImmediatePropagation(),r.stopPropagation(),!1}proxyFocus(){this.focus()}shouldProxyClick(){let r=!1;return this.anchorElement&&(this.anchorElement.click(),r=!0),r}breakItemChildrenCache(){this._itemChildren=void 0,this.triggerUpdate()}render(){return u`
            <slot name="icon"></slot>
            <div id="label">
                <slot id="slot"></slot>
            </div>
            ...
            ${this.hasSubmenu?u`
                      ...
                      ></sp-icon-chevron100>
                  `:u``}
        `}manageSubmenu(r){const t=r.target.assignedElements({flatten:!0});this.hasSubmenu=this.open||!!t.length}handleRemoveActive(r){r.type==="pointerleave"&&this.hasSubmenu||this.hasSubmenu||this.open||(this.active=!1)}handlePointerdown(){this.active=!0}firstUpdated(r){super.firstUpdated(r),this.setAttribute("tabindex","-1"),this.addEventListener("pointerdown",this.handlePointerdown),this.hasAttribute("id")||(this.id="sp-menu-item-"+us.instanceCount++),this.addEventListener("pointerenter",this.closeOverlaysForRoot)}closeOverlaysForRoot(){if(this.open)return;const r=new Ji({root:this.menuData.focusRoot});this.dispatchEvent(r)}handleSubmenuClick(){this.openOverlay()}handlePointerenter(){if(this.leaveTimeout)return clearTimeout(this.leaveTimeout),void delete this.leaveTimeout;this.openOverlay()}handlePointerleave(){this.hasSubmenu&&this.open&&(this.leaveTimeout=setTimeout(()=>{delete this.leaveTimeout,this.closeOverlay&&this.closeOverlay()},100))}async openOverlay(){if(!this.hasSubmenu||this.open||this.disabled)return;this.open=!0,this.active=!0;const r=this.shadowRoot.querySelector('slot[name="submenu"]').assignedElements()[0];r.addEventListener("pointerenter",this.handleSubmenuPointerenter),r.addEventListener("change",this.handleSubmenuChange);const t=document.createElement("sp-popover"),e=Cr([r],t,{position:"beforeend",prepareCallback:s=>{const i=s.slot;return s.tabIndex=0,s.removeAttribute("slot"),s.isSubmenu=!0,c=>{c.tabIndex=-1,c.slot=i,c.isSubmenu=!1}}}),o=Me(this,"click",t,{placement:this.isLTR?"right-start":"left-start",receivesFocus:"auto",root:this.menuData.focusRoot}),a=async()=>{delete this.closeOverlay,(await o)()};this.closeOverlay=a,this.addEventListener("sp-closed",s=>{s.stopPropagation(),delete this.closeOverlay,e(),this.open=!1,this.active=!1},{once:!0}),t.addEventListener("change",a)}updateAriaSelected(){const r=this.getAttribute("role");r==="option"?this.setAttribute("aria-selected",this.selected?"true":"false"):(r==="menuitemcheckbox"||r==="menuitemradio")&&this.setAttribute("aria-checked",this.selected?"true":"false")}setRole(r){this.setAttribute("role",r),this.updateAriaSelected()}updated(r){super.updated(r),r.has("label")&&this.setAttribute("aria-label",this.label||""),r.has("active")&&(this.active?(this.addEventListener("pointerup",this.handleRemoveActive),this.addEventListener("pointerleave",this.handleRemoveActive),this.addEventListener("pointercancel",this.handleRemoveActive)):(this.removeEventListener("pointerup",this.handleRemoveActive),this.removeEventListener("pointerleave",this.handleRemoveActive),this.removeEventListener("pointercancel",this.handleRemoveActive))),this.anchorElement&&(this.anchorElement.addEventListener("focus",this.proxyFocus),this.anchorElement.tabIndex=-1),r.has("selected")&&this.updateAriaSelected(),r.has("hasSubmenu")&&(this.hasSubmenu?(this.addEventListener("click",this.handleSubmenuClick),this.addEventListener("pointerenter",this.handlePointerenter),this.addEventListener("pointerleave",this.handlePointerleave)):this.closeOverlay||(this.removeEventListener("click",this.handleSubmenuClick),this.removeEventListener("pointerenter",this.handlePointerenter),this.removeEventListener("pointerleave",this.handlePointerleave)))}connectedCallback(){super.connectedCallback(),this.isInSubmenu=!!this.closest('[slot="submenu"]'),!this.isInSubmenu&&(Re.reset(this),this.dispatchEvent(Re),this._parentElement=this.parentElement)}disconnectedCallback(){var r;ls.reset(this),this.isInSubmenu||(r=this._parentElement)==null||r.dispatchEvent(ls),this.isInSubmenu=!1,super.disconnectedCallback()}async triggerUpdate(){this.isInSubmenu||(await new Promise(r=>requestAnimationFrame(r)),Re.reset(this),this.dispatchEvent(Re))}};let mt=us;mt.instanceCount=0,Lt([m({type:Boolean,reflect:!0})],mt.prototype,"active",2),Lt([m({type:Boolean,reflect:!0})],mt.prototype,"focused",2),Lt([m({type:Boolean,reflect:!0})],mt.prototype,"selected",2),Lt([m({type:String})],mt.prototype,"value",1),Lt([m({type:Boolean})],mt.prototype,"hasSubmenu",2),Lt([m({type:Boolean,reflect:!0,attribute:"no-wrap",hasChanged:()=>!1})],mt.prototype,"noWrap",2),Lt([tt(".anchor")],mt.prototype,"anchorElement",2),Lt([m({type:Boolean})],mt.prototype,"open",2);var ac=k`
...
`,lc=Object.defineProperty,uc=Object.getOwnPropertyDescriptor,ps=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?uc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&lc(t,e,s),s};const Mr=class extends jt{constructor(){super(),Mr.instances+=1,this.headerId=`sp-menu-group-label-${Mr.instances}`}static get styles(){return[...super.styles,nc]}get ownRole(){switch(this.selects){case"multiple":case"single":case"inherit":return"group";default:return"menu"}}updateLabel(){const r=this.headerElements.length?this.headerElements[0]:void 0;if(r!==this.headerElement)if(this.headerElement&&this.headerElement.id===this.headerId&&this.headerElement.removeAttribute("id"),r){const t=r.id||this.headerId;r.id||(r.id=t),this.setAttribute("aria-labelledby",t)}else this.removeAttribute("aria-labelledby");this.headerElement=r}render(){return u`
        ...
        `}};let Ue=Mr;Ue.instances=0,ps([Do("header",!0)],Ue.prototype,"headerElements",2),ps([dr()],Ue.prototype,"headerElement",2),y("sp-menu-group",Ue);var mc=k`
...
`;class pc extends nt(R,{validSizes:["s","m","l"]}){static get styles(){return[rs,mc]}firstUpdated(t){super.firstUpdated(t),this.setAttribute("role","separator")}}y("sp-menu-divider",pc);var dc=k`
...
`,hc=Object.defineProperty,bc=Object.getOwnPropertyDescriptor;class ds extends R{constructor(){super(...arguments),this.open=!1}static get styles(){return[gc]}render(){return u``}}((r,t,e,o)=>{for(var a,s=o>1?void 0:o?bc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);o&&s&&hc(t,e,s)})([m({type:Boolean,reflect:!0})],ds.prototype,"open",2),y("sp-underlay",ds);class gs{constructor(t,e){this.key=Symbol("match-media-key"),this.matches=!1,this.host=t,this.host.addController(this),this.media=window.matchMedia(e),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),t.addController(this)}hostConnected(){var t;(t=this.media)==null||t.addEventListener("change",this.onChange)}hostDisconnected(){var t;(t=this.media)==null||t.removeEventListener("change",this.onChange)}onChange(t){this.matches!==t.matches&&(this.matches=t.matches,this.host.requestUpdate(this.key,!this.matches))}}var vc=k`
...
`,yc=Object.defineProperty,kc=Object.getOwnPropertyDescriptor,hs=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?kc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&yc(t,e,s),s};class _r extends R{constructor(){super(...arguments),this.open=!1,this.prefersMotion=new gs(this,"(prefers-reduced-motion: no-preference)"),this.transitionPromise=Promise.resolve(),this.animating=!1}static get styles(){return[vc,fc]}focus(){const t=vr(this);t?t.focus():this.children.length===1?this.tray.focus():super.focus()}overlayWillCloseCallback(){return this.open?(this.close(),!0):this.animating}close(){this.open=!1,this.prefersMotion.matches||this.dispatchClosed()}dispatchClosed(){this.dispatchEvent(new Event("close",{bubbles:!0}))}handleUnderlayTransitionend(){this.open||(this.resolveTransitionPromise(),this.dispatchClosed())}handleTrayTransitionend(){this.open&&this.resolveTransitionPromise()}update(t){t.has("open")&&t.get("open")!==void 0&&this.prefersMotion.matches&&(this.animating=!0,this.transitionPromise=new Promise(e=>{this.resolveTransitionPromise=()=>{this.animating=!1,e()}})),super.update(t)}render(){return u`
            <sp-underlay
                ?open=${this.open}
                @click=${this.close}
        ...
        `}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.transitionPromise,t}}hs([m({type:Boolean,reflect:!0})],_r.prototype,"open",2),hs([tt(".tray")],_r.prototype,"tray",2),y("sp-tray",_r);var wc=k`
...
`,xc=Object.defineProperty,zc=Object.getOwnPropertyDescriptor,Ne=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?zc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&xc(t,e,s),s};class be extends R{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.placement="none",this.tip=!1}static get styles(){return[wc]}renderTip(){return u`
            <div id="tip">
                <svg
        ...
        `}}Ne([m({type:Boolean,reflect:!0})],be.prototype,"dialog",2),Ne([m({type:Boolean,reflect:!0})],be.prototype,"open",2),Ne([m({reflect:!0})],be.prototype,"placement",2),Ne([m({type:Boolean,reflect:!0})],be.prototype,"tip",2),y("sp-popover",be);var Cc=k`
...
`;const ee=r=>{if(!r)return null;const t=r.closest("active-overlay");if(t)return t;const e=r.getRootNode();return e.host?ee(e.host):null},Rr=(r,t)=>{const e=[];if(!r)return[];for(const o of t)o.root&&ee(o.root)===r&&(e.push(o),e.push(...Rr(o,t)));return e};function re(r){return r.split("-")[1]}function Ur(r){return r==="y"?"height":"width"}function Dt(r){return r.split("-")[0]}function oe(r){return["top","bottom"].includes(Dt(r))?"x":"y"}function bs(r,t,e){let{reference:o,floating:a}=r;const s=o.x+o.width/2-a.width/2,i=o.y+o.height/2-a.height/2,c=oe(t),n=Ur(c),l=o[n]/2-a[n]/2,p=c==="x";let d;switch(Dt(t)){case"top":d={x:s,y:o.y-a.height};break;case"bottom":d={x:s,y:o.y+o.height};break;case"right":d={x:o.x+o.width,y:i};break;case"left":d={x:o.x-a.width,y:i};break;default:d={x:o.x,y:o.y}}switch(re(t)){case"start":d[c]-=l*(e&&p?-1:1);break;case"end":d[c]+=l*(e&&p?-1:1)}return d}function vs(r){return typeof r!="number"?function(t){return{top:0,right:0,bottom:0,left:0,...t}}(r):{top:r,right:r,bottom:r,left:r}}function Fe(r){return{...r,top:r.y,left:r.x,right:r.x+r.width,bottom:r.y+r.height}}async function Nr(r,t){var e;t===void 0&&(t={});const{x:o,y:a,platform:s,rects:i,elements:c,strategy:n}=r,{boundary:l="clippingAncestors",rootBoundary:p="viewport",elementContext:d="floating",altBoundary:g=!1,padding:h=0}=t,b=vs(h),f=c[g?d==="floating"?"reference":"floating":d],A=Fe(await s.getClippingRect({element:(e=await(s.isElement==null?void 0:s.isElement(f)))==null||e?f:f.contextElement||await(s.getDocumentElement==null?void 0:s.getDocumentElement(c.floating)),boundary:l,rootBoundary:p,strategy:n})),v=d==="floating"?{...i.floating,x:o,y:a}:i.reference,C=await(s.getOffsetParent==null?void 0:s.getOffsetParent(c.floating)),j=await(s.isElement==null?void 0:s.isElement(C))&&await(s.getScale==null?void 0:s.getScale(C))||{x:1,y:1},w=Fe(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({rect:v,offsetParent:C,strategy:n}):v);return{top:(A.top-w.top+b.top)/j.y,bottom:(w.bottom-A.bottom+b.bottom)/j.y,left:(A.left-w.left+b.left)/j.x,right:(w.right-A.right+b.right)/j.x}}const Fr=Math.min,Mt=Math.max;function Vr(r,t,e){return Mt(r,Fr(t,e))}const jc={left:"right",right:"left",bottom:"top",top:"bottom"};function Ve(r){return r.replace(/left|right|bottom|top/g,t=>jc[t])}const Ac={start:"end",end:"start"};function Wr(r){return r.replace(/start|end/g,t=>Ac[t])}const fs=function(r){return r===void 0&&(r={}),{name:"flip",options:r,async fn(t){var e;const{placement:o,middlewareData:a,rects:s,initialPlacement:i,platform:c,elements:n}=t,{mainAxis:l=!0,crossAxis:p=!0,fallbackPlacements:d,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:h="none",flipAlignment:b=!0,...f}=r,A=Dt(o),v=Dt(i)===i,C=await(c.isRTL==null?void 0:c.isRTL(n.floating)),j=d||(v||!b?[Ve(i)]:function(z){const S=Ve(z);return[Wr(z),S,Wr(S)]}(i));d||h==="none"||j.push(...function(z,S,T,P){const F=re(z);let O=function(J,W,at){const Bt=["left","right"],ie=["right","left"],ze=["top","bottom"],Ce=["bottom","top"];switch(J){case"top":case"bottom":return at?W?ie:Bt:W?Bt:ie;case"left":case"right":return W?ze:Ce;default:return[]}}(Dt(z),T==="start",P);return F&&(O=O.map(J=>J+"-"+F),S&&(O=O.concat(O.map(Wr)))),O}(i,b,h,C));const w=[i,...j],H=await Nr(t,f),x=[];let E=((e=a.flip)==null?void 0:e.overflows)||[];if(l&&x.push(H[A]),p){const{main:z,cross:S}=function(T,P,F){F===void 0&&(F=!1);const O=re(T),J=oe(T),W=Ur(J);let at=J==="x"?O===(F?"end":"start")?"right":"left":O==="start"?"bottom":"top";return P.reference[W]>P.floating[W]&&(at=Ve(at)),{main:at,cross:Ve(at)}}(o,s,C);x.push(H[z],H[S])}if(E=[...E,{placement:o,overflows:x}],!x.every(z=>z<=0)){var B,M;const z=(((B=a.flip)==null?void 0:B.index)||0)+1,S=w[z];if(S)return{data:{index:z,overflows:E},reset:{placement:S}};let T=(M=E.filter(P=>P.overflows[0]<=0).sort((P,F)=>P.overflows[1]-F.overflows[1])[0])==null?void 0:M.placement;if(!T)switch(g){case"bestFit":{var _;const P=(_=E.map(F=>[F.placement,F.overflows.filter(O=>O>0).reduce((O,J)=>O+J,0)]).sort((F,O)=>F[1]-O[1])[0])==null?void 0:_[0];P&&(T=P);break}case"initialPlacement":T=i}if(o!==T)return{reset:{placement:T}}}return{}}}},Ec=function(r){return r===void 0&&(r=0),{name:"offset",options:r,async fn(t){const{x:e,y:o}=t,a=await async function(s,i){const{placement:c,platform:n,elements:l}=s,p=await(n.isRTL==null?void 0:n.isRTL(l.floating)),d=Dt(c),g=re(c),h=oe(c)==="x",b=["left","top"].includes(d)?-1:1,f=p&&h?-1:1,A=typeof i=="function"?i(s):i;let{mainAxis:v,crossAxis:C,alignmentAxis:j}=typeof A=="number"?{mainAxis:A,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...A};return g&&typeof j=="number"&&(C=g==="end"?-1*j:j),h?{x:C*f,y:v*b}:{x:v*b,y:C*f}}(t,r);return{x:e+a.x,y:o+a.y,data:a}}}},Hc=function(r){return r===void 0&&(r={}),{name:"size",options:r,async fn(t){const{placement:e,rects:o,platform:a,elements:s}=t,{apply:i=()=>{},...c}=r,n=await Nr(t,c),l=Dt(e),p=re(e),d=oe(e)==="x",{width:g,height:h}=o.floating;let b,f;l==="top"||l==="bottom"?(b=l,f=p===(await(a.isRTL==null?void 0:a.isRTL(s.floating))?"start":"end")?"left":"right"):(f=l,b=p==="end"?"top":"bottom");const A=h-n[b],v=g-n[f],C=!t.middlewareData.shift;let j=A,w=v;if(d){const x=g-n.left-n.right;w=p||C?Fr(v,x):x}else{const x=h-n.top-n.bottom;j=p||C?Fr(A,x):x}if(C&&!p){const x=Mt(n.left,0),E=Mt(n.right,0),B=Mt(n.top,0),M=Mt(n.bottom,0);d?w=g-2*(x!==0||E!==0?x+E:Mt(n.left,n.right)):j=h-2*(B!==0||M!==0?B+M:Mt(n.top,n.bottom))}await i({...t,availableWidth:w,availableHeight:j});const H=await a.getDimensions(s.floating);return g!==H.width||h!==H.height?{reset:{rects:!0}}:{}}}};function it(r){var t;return((t=r.ownerDocument)==null?void 0:t.defaultView)||window}function ft(r){return it(r).getComputedStyle(r)}function ys(r){return r instanceof it(r).Node}function $t(r){return ys(r)?(r.nodeName||"").toLowerCase():""}let We;function ks(){if(We)return We;const r=navigator.userAgentData;return r&&Array.isArray(r.brands)?(We=r.brands.map(t=>t.brand+"/"+t.version).join(" "),We):navigator.userAgent}function pt(r){return r instanceof it(r).HTMLElement}function dt(r){return r instanceof it(r).Element}function ws(r){return typeof ShadowRoot>"u"?!1:r instanceof it(r).ShadowRoot||r instanceof ShadowRoot}function Ge(r){const{overflow:t,overflowX:e,overflowY:o,display:a}=ft(r);return/auto|scroll|overlay|hidden|clip/.test(t+o+e)&&!["inline","contents"].includes(a)}function Ic(r){return["table","td","th"].includes($t(r))}function Gr(r){const t=/firefox/i.test(ks()),e=ft(r),o=e.backdropFilter||e.WebkitBackdropFilter;return e.transform!=="none"||e.perspective!=="none"||!!o&&o!=="none"||t&&e.willChange==="filter"||t&&!!e.filter&&e.filter!=="none"||["transform","perspective"].some(a=>e.willChange.includes(a))||["paint","layout","strict","content"].some(a=>{const s=e.contain;return s!=null&&s.includes(a)})}function Kr(){return/^((?!chrome|android).)*safari/i.test(ks())}function Zr(r){return["html","body","#document"].includes($t(r))}const xs=Math.min,ve=Math.max,Ke=Math.round;function zs(r){const t=ft(r);let e=parseFloat(t.width),o=parseFloat(t.height);const a=pt(r),s=a?r.offsetWidth:e,i=a?r.offsetHeight:o,c=Ke(e)!==s||Ke(o)!==i;return c&&(e=s,o=i),{width:e,height:o,fallback:c}}function Cs(r){return dt(r)?r:r.contextElement}const js={x:1,y:1};function se(r){const t=Cs(r);if(!pt(t))return js;const e=t.getBoundingClientRect(),{width:o,height:a,fallback:s}=zs(t);let i=(s?Ke(e.width):e.width)/o,c=(s?Ke(e.height):e.height)/a;return i&&Number.isFinite(i)||(i=1),c&&Number.isFinite(c)||(c=1),{x:i,y:c}}function _t(r,t,e,o){var a,s;t===void 0&&(t=!1),e===void 0&&(e=!1);const i=r.getBoundingClientRect(),c=Cs(r);let n=js;t&&(o?dt(o)&&(n=se(o)):n=se(r));const l=c?it(c):window,p=Kr()&&e;let d=(i.left+(p&&((a=l.visualViewport)==null?void 0:a.offsetLeft)||0))/n.x,g=(i.top+(p&&((s=l.visualViewport)==null?void 0:s.offsetTop)||0))/n.y,h=i.width/n.x,b=i.height/n.y;if(c){const f=it(c),A=o&&dt(o)?it(o):o;let v=f.frameElement;for(;v&&o&&A!==f;){const C=se(v),j=v.getBoundingClientRect(),w=getComputedStyle(v);j.x+=(v.clientLeft+parseFloat(w.paddingLeft))*C.x,j.y+=(v.clientTop+parseFloat(w.paddingTop))*C.y,d*=C.x,g*=C.y,h*=C.x,b*=C.y,d+=j.x,g+=j.y,v=it(v).frameElement}}return Fe({width:h,height:b,x:d,y:g})}function qt(r){return((ys(r)?r.ownerDocument:r.document)||window.document).documentElement}function Ze(r){return dt(r)?{scrollLeft:r.scrollLeft,scrollTop:r.scrollTop}:{scrollLeft:r.pageXOffset,scrollTop:r.pageYOffset}}function As(r){return _t(qt(r)).left+Ze(r).scrollLeft}function fe(r){if($t(r)==="html")return r;const t=r.assignedSlot||r.parentNode||ws(r)&&r.host||qt(r);return ws(t)?t.host:t}function Es(r){const t=fe(r);return Zr(t)?t.ownerDocument.body:pt(t)&&Ge(t)?t:Es(t)}function ye(r,t){var e;t===void 0&&(t=[]);const o=Es(r),a=o===((e=r.ownerDocument)==null?void 0:e.body),s=it(o);return a?t.concat(s,s.visualViewport||[],Ge(o)?o:[]):t.concat(o,ye(o))}function Hs(r,t,e){let o;if(t==="viewport")o=function(i,c){const n=it(i),l=qt(i),p=n.visualViewport;let d=l.clientWidth,g=l.clientHeight,h=0,b=0;if(p){d=p.width,g=p.height;const f=Kr();(!f||f&&c==="fixed")&&(h=p.offsetLeft,b=p.offsetTop)}return{width:d,height:g,x:h,y:b}}(r,e);else if(t==="document")o=function(i){const c=qt(i),n=Ze(i),l=i.ownerDocument.body,p=ve(c.scrollWidth,c.clientWidth,l.scrollWidth,l.clientWidth),d=ve(c.scrollHeight,c.clientHeight,l.scrollHeight,l.clientHeight);let g=-n.scrollLeft+As(i);const h=-n.scrollTop;return ft(l).direction==="rtl"&&(g+=ve(c.clientWidth,l.clientWidth)-p),{width:p,height:d,x:g,y:h}}(qt(r));else if(dt(t))o=function(i,c){const n=_t(i,!0,c==="fixed"),l=n.top+i.clientTop,p=n.left+i.clientLeft,d=pt(i)?se(i):{x:1,y:1};return{width:i.clientWidth*d.x,height:i.clientHeight*d.y,x:p*d.x,y:l*d.y}}(t,e);else{const i={...t};if(Kr()){var a,s;const c=it(r);i.x-=((a=c.visualViewport)==null?void 0:a.offsetLeft)||0,i.y-=((s=c.visualViewport)==null?void 0:s.offsetTop)||0}o=i}return Fe(o)}function Is(r,t){return pt(r)&&ft(r).position!=="fixed"?t?t(r):r.offsetParent:null}function Ss(r,t){const e=it(r);if(!pt(r))return e;let o=Is(r,t);for(;o&&Ic(o)&&ft(o).position==="static";)o=Is(o,t);return o&&($t(o)==="html"||$t(o)==="body"&&ft(o).position==="static"&&!Gr(o))?e:o||function(a){let s=fe(a);for(;pt(s)&&!Zr(s);){if(Gr(s))return s;s=fe(s)}return null}(r)||e}function Sc(r,t,e){const o=pt(t),a=qt(t),s=_t(r,!0,e==="fixed",t);let i={scrollLeft:0,scrollTop:0};const c={x:0,y:0};if(o||!o&&e!=="fixed")if(($t(t)!=="body"||Ge(a))&&(i=Ze(t)),pt(t)){const n=_t(t,!0);c.x=n.x+t.clientLeft,c.y=n.y+t.clientTop}else a&&(c.x=As(a));return{x:s.left+i.scrollLeft-c.x,y:s.top+i.scrollTop-c.y,width:s.width,height:s.height}}const Tc={getClippingRect:function(r){let{element:t,boundary:e,rootBoundary:o,strategy:a}=r;const s=[...e==="clippingAncestors"?function(n,l){const p=l.get(n);if(p)return p;let d=ye(n).filter(f=>dt(f)&&$t(f)!=="body"),g=null;const h=ft(n).position==="fixed";let b=h?fe(n):n;for(;dt(b)&&!Zr(b);){const f=ft(b),A=Gr(b);f.position==="fixed"&&(g=null),(h?A||g:A||f.position!=="static"||!g||!["absolute","fixed"].includes(g.position))?g=f:d=d.filter(v=>v!==b),b=fe(b)}return l.set(n,d),d}(t,this._c):[].concat(e),o],i=s[0],c=s.reduce((n,l)=>{const p=Hs(t,l,a);return n.top=ve(p.top,n.top),n.right=xs(p.right,n.right),n.bottom=xs(p.bottom,n.bottom),n.left=ve(p.left,n.left),n},Hs(t,i,a));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}},convertOffsetParentRelativeRectToViewportRelativeRect:function(r){let{rect:t,offsetParent:e,strategy:o}=r;const a=pt(e),s=qt(e);if(e===s)return t;let i={scrollLeft:0,scrollTop:0},c={x:1,y:1};const n={x:0,y:0};if((a||!a&&o!=="fixed")&&(($t(e)!=="body"||Ge(s))&&(i=Ze(e)),pt(e))){const l=_t(e);c=se(e),n.x=l.x+e.clientLeft,n.y=l.y+e.clientTop}return{width:t.width*c.x,height:t.height*c.y,x:t.x*c.x-i.scrollLeft*c.x+n.x,y:t.y*c.y-i.scrollTop*c.y+n.y}},isElement:dt,getDimensions:function(r){return zs(r)},getOffsetParent:Ss,getDocumentElement:qt,getScale:se,async getElementRects(r){let{reference:t,floating:e,strategy:o}=r;const a=this.getOffsetParent||Ss,s=this.getDimensions;return{reference:Sc(t,await a(e),o),floating:{x:0,y:0,...await s(e)}}},getClientRects:r=>Array.from(r.getClientRects()),isRTL:r=>ft(r).direction==="rtl"},Lc=(r,t,e)=>{const o=new Map,a={platform:Tc,...e},s={...a.platform,_c:o};return(async(i,c,n)=>{const{placement:l="bottom",strategy:p="absolute",middleware:d=[],platform:g}=n,h=d.filter(Boolean),b=await(g.isRTL==null?void 0:g.isRTL(c));let f=await g.getElementRects({reference:i,floating:c,strategy:p}),{x:A,y:v}=bs(f,l,b),C=l,j={},w=0;for(let H=0;H<h.length;H++){const{name:x,fn:E}=h[H],{x:B,y:M,data:_,reset:z}=await E({x:A,y:v,initialPlacement:l,placement:C,strategy:p,middlewareData:j,rects:f,platform:g,elements:{reference:i,floating:c}});A=B!=null?B:A,v=M!=null?M:v,j={...j,[x]:{...j[x],..._}},z&&w<=50&&(w++,typeof z=="object"&&(z.placement&&(C=z.placement),z.rects&&(f=z.rects===!0?await g.getElementRects({reference:i,floating:c,strategy:p}):z.rects),{x:A,y:v}=bs(f,C,b)),H=-1)}return{x:A,y:v,placement:C,strategy:p,middlewareData:j}})(r,t,{...a,platform:s})};var Dc=Object.defineProperty,$c=Object.getOwnPropertyDescriptor,ke=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?$c(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Dc(t,e,s),s};const Ts={initial:"idle",states:{idle:{on:{active:"active"}},active:{on:{hiding:"hiding",idle:"idle"}},hiding:{on:{dispose:"dispose"}},dispose:{on:{disposed:"disposed"}},disposed:{on:{}}}},Ls=(r,t)=>r?t&&Ts.states[r].on[t]||r:Ts.initial,qc=r=>{var t;return(t={left:["right","bottom","top"],"left-start":["right-start","bottom","top"],"left-end":["right-end","bottom","top"],right:["left","bottom","top"],"right-start":["left-start","bottom","top"],"right-end":["left-end","bottom","top"],top:["bottom","left","right"],"top-start":["bottom-start","left","right"],"top-end":["bottom-end","left","right"],bottom:["top","left","right"],"bottom-start":["top-start","left","right"],"bottom-end":["top-end","left","right"]}[r])!=null?t:[r]},Ds=class extends R{constructor(){super(),this.contentAnimationPromise=Promise.resolve(!0),this.resolveContentAnimationPromise=()=>{},this._state=Ls(),this.animating=!1,this.theme={},this.tabbingAway=!1,this.offset=6,this.skidding=0,this.interaction="hover",this.positionAnimationFrame=0,this.willNotifyClosed=!1,this.isConstrained=!1,this.updateOverlayPosition=()=>{this.interaction!=="modal"&&this.cleanup?this.dispatchEvent(new Event("close")):this.setOverlayPosition()},this.resetOverlayPosition=()=>{this.style.removeProperty("max-height"),this.style.removeProperty("height"),this.initialHeight=void 0,this.isConstrained=!1,this.offsetHeight,this.setOverlayPosition()},this.setOverlayPosition=async()=>{if(!this.placement||this.placement==="none")return;function r(n){const l=window.devicePixelRatio||1;return Math.round(n*l)/l||-1e4}await(document.fonts?document.fonts.ready:Promise.resolve());const t=this.virtualTrigger?fs({padding:8,fallbackPlacements:qc(this.placement)}):fs({padding:8}),e=[Ec({mainAxis:this.offset,crossAxis:this.skidding}),(o={padding:8},o===void 0&&(o={}),{name:"shift",options:o,async fn(n){const{x:l,y:p,placement:d}=n,{mainAxis:g=!0,crossAxis:h=!1,limiter:b={fn:E=>{let{x:B,y:M}=E;return{x:B,y:M}}},...f}=o,A={x:l,y:p},v=await Nr(n,f),C=oe(Dt(d)),j=C==="x"?"y":"x";let w=A[C],H=A[j];if(g){const E=C==="y"?"bottom":"right";w=Vr(w+v[C==="y"?"top":"left"],w,w-v[E])}if(h){const E=j==="y"?"bottom":"right";H=Vr(H+v[j==="y"?"top":"left"],H,H-v[E])}const x=b.fn({...n,[C]:w,[j]:H});return{...x,data:{x:x.x-l,y:x.y-p}}}}),t,Hc({padding:8,apply:({availableWidth:n,availableHeight:l,rects:{floating:p}})=>{const d=Math.max(100,Math.floor(l)),g=p.height;this.initialHeight=(this.isConstrained||this.virtualTrigger)&&this.initialHeight||g,this.isConstrained=g<this.initialHeight||d<=g;const h=this.isConstrained?`${d}px`:"";Object.assign(this.style,{maxWidth:`${Math.floor(n)}px`,maxHeight:h,height:h})}})];var o;this.overlayContentTip&&e.push((n=>({name:"arrow",options:n,async fn(l){const{element:p,padding:d=0}=n||{},{x:g,y:h,placement:b,rects:f,platform:A,elements:v}=l;if(p==null)return{};const C=vs(d),j={x:g,y:h},w=oe(b),H=Ur(w),x=await A.getDimensions(p),E=w==="y",B=E?"top":"left",M=E?"bottom":"right",_=E?"clientHeight":"clientWidth",z=f.reference[H]+f.reference[w]-j[w]-f.floating[H],S=j[w]-f.reference[w],T=await(A.getOffsetParent==null?void 0:A.getOffsetParent(p));let P=T?T[_]:0;P&&await(A.isElement==null?void 0:A.isElement(T))||(P=v.floating[_]||f.floating[H]);const F=z/2-S/2,O=C[B],J=P-x[H]-C[M],W=P/2-x[H]/2+F,at=Vr(O,W,J),Bt=re(b)!=null&&W!=at&&f.reference[H]/2-(W<O?C[B]:C[M])-x[H]/2<0;return{[w]:j[w]-(Bt?W<O?O-W:J-W:0),data:{[w]:at,centerOffset:W-at}}}}))({element:this.overlayContentTip}));const{x:a,y:s,placement:i,middlewareData:c}=await Lc(this.virtualTrigger||this.trigger,this,{placement:this.placement,middleware:e,strategy:"fixed"});if(Object.assign(this.style,{top:"0px",left:"0px",transform:`translate(${r(a)}px, ${r(s)}px)`}),i!==this.getAttribute("actual-placement")&&(this.setAttribute("actual-placement",i),this.overlayContent.setAttribute("placement",i)),this.overlayContentTip&&c.arrow){const{x:n,y:l}=c.arrow;Object.assign(this.overlayContentTip.style,{left:n!=null?`${r(n)}px`:"",top:l!=null?`${r(l)}px`:"",right:"",bottom:""})}},this.handleInlineTriggerKeydown=r=>{const{code:t,shiftKey:e}=r;if(t==="Tab"){if(e)return this.tabbingAway=!0,void this.dispatchEvent(new Event("close"));r.stopPropagation(),r.preventDefault(),this.focus()}},this.stealOverlayContentPromise=Promise.resolve(),this.stealOverlayContentPromise=new Promise(r=>this.stealOverlayContentResolver=r)}get state(){return this._state}set state(r){const t=Ls(this.state,r);t!==this.state&&(this._state=t,this.state==="active"||this.state==="hiding"?this.setAttribute("state",this.state):this.removeAttribute("state"))}async focus(){const r=vr(this);if(r){r.updateComplete&&await r.updateComplete;const t=this.getRootNode().activeElement;(t===this||!this.contains(t))&&r.focus()}else super.focus();this.removeAttribute("tabindex")}get hasTheme(){return!!this.theme.color||!!this.theme.scale||!!this.theme.lang}static get styles(){return[Cc]}get hasModalRoot(){return!!this._modalRoot}feature(){this.contains(document.activeElement)||(this.tabIndex=-1);const r=ee(this.trigger);r&&r.slot==="open"&&(this._modalRoot=r._modalRoot||r),(this.interaction==="modal"||this._modalRoot)&&(this.slot="open",this.interaction==="modal"&&this.setAttribute("aria-modal","true"),this._modalRoot&&(r==null||r.feature()))}obscure(r){if(this.slot&&r==="modal"){if(this.removeAttribute("slot"),this.removeAttribute("aria-modal"),this.interaction!=="modal"){const t=ee(this.trigger);return this._modalRoot=t==null?void 0:t.obscure(r),this._modalRoot}return this}}async willUpdate(){this.hasUpdated||!this.overlayContent||!this.trigger||(this.stealOverlayContent(this.overlayContent),this.state="active",this.feature(),this.placement&&this.placement!=="none"&&(await this.updateOverlayPosition(),document.addEventListener("sp-update-overlays",this.resetOverlayPosition)),this.placement&&this.placement!=="none"&&(this.contentAnimationPromise=this.applyContentAnimation("sp-overlay-fade-in")))}async openCallback(r){await this.updateComplete,this.receivesFocus&&await this.focus(),await r(),this.trigger.dispatchEvent(new CustomEvent("sp-opened",{bubbles:!0,composed:!0,cancelable:!0,detail:{interaction:this.interaction}}))}open(r){this.extractDetail(r)}extractDetail(r){this.overlayContent=r.content,this.overlayContentTip=r.contentTip,this.trigger=r.trigger,this.virtualTrigger=r.virtualTrigger,this.placement=r.placement,this.offset=r.offset,this.skidding=r.skidding||0,this.interaction=r.interaction,this.theme=r.theme,this.receivesFocus=r.receivesFocus,this.root=r.root}dispose(){this.state==="dispose"&&(this.timeout&&(clearTimeout(this.timeout),delete this.timeout),this.trigger.removeEventListener("keydown",this.handleInlineTriggerKeydown),this.returnOverlayContent(),this.state="disposed",this.willNotifyClosed&&(this.overlayContent.dispatchEvent(new Event("sp-overlay-closed")),this.willNotifyClosed=!1),this.cleanup&&this.cleanup())}stealOverlayContent(r){this.originalPlacement=r.getAttribute("placement"),this.restoreContent=Cr([r],this,{position:"beforeend",prepareCallback:t=>{const e=t.slot,o=t.placement;return t.removeAttribute("slot"),a=>{a.slot=e,a.placement=o}}}),this.stealOverlayContentResolver()}returnOverlayContent(){if(!this.restoreContent)return;const[r]=this.restoreContent();this.restoreContent=void 0,this.willNotifyClosed=!0,this.originalPlacement&&(r.setAttribute("placement",this.originalPlacement),delete this.originalPlacement)}async placeOverlay(){!this.placement||this.placement==="none"||(this.cleanup=function(r,t,e,o){o===void 0&&(o={});const{ancestorScroll:a=!0,ancestorResize:s=!0,elementResize:i=!0,animationFrame:c=!1}=o,n=a&&!c,l=n||s?[...dt(r)?ye(r):r.contextElement?ye(r.contextElement):[],...ye(t)]:[];l.forEach(h=>{n&&h.addEventListener("scroll",e,{passive:!0}),s&&h.addEventListener("resize",e)});let p,d=null;i&&(d=new ResizeObserver(()=>{e()}),dt(r)&&!c&&d.observe(r),dt(r)||!r.contextElement||c||d.observe(r.contextElement),d.observe(t));let g=c?_t(r):null;return c&&function h(){const b=_t(r);!g||b.x===g.x&&b.y===g.y&&b.width===g.width&&b.height===g.height||e(),g=b,p=requestAnimationFrame(h)}(),e(),()=>{var h;l.forEach(b=>{n&&b.removeEventListener("scroll",e),s&&b.removeEventListener("resize",e)}),(h=d)==null||h.disconnect(),d=null,c&&cancelAnimationFrame(p)}}(this.virtualTrigger||this.trigger,this,this.updateOverlayPosition,{elementResize:!1}))}async hide(r=!0){this.state==="active"&&(this.state="hiding",r&&await this.applyContentAnimation("sp-overlay-fade-out"),this.state="dispose")}schedulePositionUpdate(){cancelAnimationFrame(this.positionAnimationFrame),this.positionAnimationFrame=requestAnimationFrame(()=>{this.cleanup?this.updateOverlayPosition():this.placeOverlay()})}onSlotChange(){this.schedulePositionUpdate()}applyContentAnimation(r){return this.placement==="none"?Promise.resolve(!0):(this.resolveContentAnimationPromise(),new Promise(t=>{this.resolveContentAnimationPromise=()=>{t(!1)};const e=this.shadowRoot.querySelector("#contents"),o=a=>{r===a.animationName&&(e.removeEventListener("animationend",o),e.removeEventListener("animationcancel",o),this.animating=!1,t(a.type==="animationcancel"))};e.addEventListener("animationend",o),e.addEventListener("animationcancel",o),e.style.animationName=r,this.animating=!0}))}renderTheme(r){const{color:t,scale:e,lang:o,theme:a}=this.theme;return u`
            <sp-theme
                theme=${I(a)}
                color=${I(t)}
                scale=${I(e)}
        ...
        `;return this.hasTheme?this.renderTheme(r):r}static create(r){const t=new Ds;return r.content&&t.open(r),t}async getUpdateComplete(){const r=[super.getUpdateComplete(),this.stealOverlayContentPromise];r.push(this.contentAnimationPromise),this.overlayContent.updateComplete!==void 0&&r.push(this.overlayContent.updateComplete);const[t]=await Promise.all(r);return t}disconnectedCallback(){document.removeEventListener("sp-update-overlays",this.resetOverlayPosition),super.disconnectedCallback()}};let Rt=Ds;ke([m()],Rt.prototype,"_state",2),ke([m({reflect:!0,type:Boolean})],Rt.prototype,"animating",2),ke([m({reflect:!0})],Rt.prototype,"placement",2),ke([m({attribute:!1})],Rt.prototype,"theme",2),ke([m({attribute:!1})],Rt.prototype,"receivesFocus",2);class Bc{constructor(t={}){this.warmUpDelay=1e3,this.coolDownDelay=1e3,this.isWarm=!1,this.timeout=0,Object.assign(this,t)}async openTimer(t){if(this.cancelCooldownTimer(),!this.component||t!==this.component)return this.component&&(this.close(this.component),this.cancelCooldownTimer()),this.component=t,!this.isWarm&&(this.promise=new Promise(e=>{this.resolve=e,this.timeout=window.setTimeout(()=>{this.resolve&&(this.resolve(!1),this.isWarm=!0)},this.warmUpDelay)}),this.promise);if(this.promise)return this.promise;throw new Error("Inconsistent state")}close(t){this.component&&this.component===t&&(this.resetCooldownTimer(),this.timeout>0&&(clearTimeout(this.timeout),this.timeout=0),this.resolve&&(this.resolve(!0),delete this.resolve),delete this.promise,delete this.component)}resetCooldownTimer(){this.isWarm&&(this.cooldownTimeout&&window.clearTimeout(this.cooldownTimeout),this.cooldownTimeout=window.setTimeout(()=>{this.isWarm=!1,delete this.cooldownTimeout},this.coolDownDelay))}cancelCooldownTimer(){this.cooldownTimeout&&window.clearTimeout(this.cooldownTimeout),delete this.cooldownTimeout}}y("active-overlay",Rt);function $s(){return new Promise(r=>requestAnimationFrame(()=>r()))}const Xe=class{constructor(r,t,e){this.isOpen=!1,this.owner=r,this.overlayElement=e,this.interaction=t}static async open(r,t,e,o){const a=new Xe(r,t,e);return await a.open(o),()=>{a.close()}}static update(){const r=new CustomEvent("sp-update-overlays",{bubbles:!0,composed:!0,cancelable:!0});document.dispatchEvent(r)}async open({abortPromise:r,delayed:t,offset:e=0,placement:o="top",receivesFocus:a,notImmediatelyClosable:s,virtualTrigger:i,root:c}){if(this.isOpen)return!0;t===void 0&&(t=this.overlayElement.hasAttribute("delayed"));const n={color:void 0,scale:void 0,lang:void 0,theme:void 0},l=new CustomEvent("sp-query-theme",{bubbles:!0,composed:!0,detail:n,cancelable:!0});this.owner.dispatchEvent(l);const p={},d=new CustomEvent("sp-overlay-query",{bubbles:!0,composed:!0,detail:p,cancelable:!0});return this.overlayElement.dispatchEvent(d),await Xe.overlayStack.openOverlay({abortPromise:r,content:this.overlayElement,contentTip:p.overlayContentTipElement,delayed:t,offset:e,placement:o,trigger:this.owner,interaction:this.interaction,theme:n,receivesFocus:a,root:c,notImmediatelyClosable:s,virtualTrigger:i,...p}),this.isOpen=!0,!0}close(){Xe.overlayStack.closeOverlay(this.overlayElement)}};let Xr=Xe;Xr.overlayStack=new class{constructor(){this.overlays=[],this.preventMouseRootClose=!1,this.root=document.body,this.handlingResize=!1,this.overlayTimer=new Bc,this.canTabTrap=!0,this.trappingInited=!1,this._eventsAreBound=!1,this._bodyMarginsApplied=!1,this.forwardContextmenuEvent=async r=>{var t;const e=this.overlays[this.overlays.length-1];!this.trappingInited||e.interaction!=="modal"||r.target!==this.overlayHolder||(r.stopPropagation(),r.preventDefault(),await this.closeTopOverlay(),(t=((o,a)=>{let s=document.elementFromPoint(o,a);for(;s!=null&&s.shadowRoot;){const i=s.shadowRoot.elementFromPoint(o,a);if(!i||i===s)break;s=i}return s})(r.clientX,r.clientY))==null||t.dispatchEvent(new MouseEvent("contextmenu",r)))},this.handleOverlayClose=r=>{const{root:t}=r;t&&this.closeOverlaysForRoot(t)},this.handleMouseCapture=r=>{const t=this.topOverlay;if(r.target&&t&&t.overlayContent&&!function(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}(r)&&function(e){return e.button===0}(r)){if(r.target instanceof Node){if(r.composedPath().indexOf(t.overlayContent)>=0)return void(this.preventMouseRootClose=!0);this.preventMouseRootClose=!1}}else this.preventMouseRootClose=!0},this._doesNotCloseOnFirstClick=!1,this.handleMouse=r=>{var t;if(this._doesNotCloseOnFirstClick)return void(this._doesNotCloseOnFirstClick=!1);if(this.preventMouseRootClose||r.defaultPrevented)return;const e=[];let o=this.overlays.length;for(;o&&e.length===0;){o-=1;const i=this.overlays[o],c=r.composedPath();(!c.includes(i.trigger)||i.interaction!=="hover")&&!c.includes(i.overlayContent)&&e.push(i)}let a=(t=this.topOverlay)==null?void 0:t.root,s=ee(a);for(;a&&s;)e.push(s),s=ee(a),a=s==null?void 0:s.root;s&&e.push(s),e.forEach(i=>this.hideAndCloseOverlay(i))},this.handleKeydown=r=>{r.code==="Escape"&&this.closeTopOverlay()},this.handleResize=()=>{this.handlingResize||(this.handlingResize=!0,requestAnimationFrame(async()=>{const r=this.overlays.map(t=>t.updateOverlayPosition());await Promise.all(r),this.handlingResize=!1}))},this.initTabTrapping()}initTabTrapping(){if(document.readyState==="loading")return void document.addEventListener("readystatechange",()=>{this.initTabTrapping()},{once:!0});if(this.trappingInited)return;if(this.trappingInited=!0,this.document.body.shadowRoot)return void(this.canTabTrap=!1);if(this.document.body.attachShadow({mode:"open"}),!this.document.body.shadowRoot)return;const r=this.document.body.shadowRoot;r.innerHTML=`
            <style>
            :host {
                position: relative;
            }
        ...
        `}updateMenuItems(t){if(this.open&&(t==null?void 0:t.type)==="sp-menu-item-removed"||this._willUpdateItems)return;this._willUpdateItems=!0,(t==null?void 0:t.item)===this.selectedItem&&this.requestUpdate();let e=()=>{};this.itemsUpdated=new Promise(o=>e=o),window.requestAnimationFrame(async()=>{this.open?(await this.optionsMenu.updateComplete,this.menuItems=this.optionsMenu.childItems):this.menuItems=[...this.querySelectorAll('sp-menu-item:not([slot="submenu"] *)')],this.manageSelection(),e(),this._willUpdateItems=!1})}async manageSelection(){if(this.selects==null)return;let t;await this.menuStatePromise,this.selectionPromise=new Promise(e=>this.selectionResolver=e),this.menuItems.forEach(e=>{this.value!==e.value||e.disabled?e.selected=!1:t=e}),t?(t.selected=!!this.selects,this.selectedItem=t):(this.value="",this.selectedItem=void 0),this.open&&(await this.optionsMenu.updateComplete,this.optionsMenu.updateSelectedItemIndex()),this.selectionResolver()}async getUpdateComplete(){const t=await super.getUpdateComplete();return await this.menuStatePromise,await this.itemsUpdated,await this.selectionPromise,t}connectedCallback(){this.updateMenuItems(),this.addEventListener("sp-menu-item-added-or-updated",this.updateMenuItems),this.addEventListener("sp-menu-item-removed",this.updateMenuItems),super.connectedCallback()}disconnectedCallback(){this.close(),super.disconnectedCallback()}}ot.openOverlay=async(r,t,e,o)=>await Me(r,t,e,o),lt([tt("#button")],ot.prototype,"button",2),lt([m({type:Boolean,reflect:!0})],ot.prototype,"disabled",2),lt([m({type:Boolean,reflect:!0})],ot.prototype,"focused",2),lt([m({type:String,reflect:!0})],ot.prototype,"icons",2),lt([m({type:Boolean,reflect:!0})],ot.prototype,"invalid",2),lt([m()],ot.prototype,"label",2),lt([m({type:Boolean,reflect:!0})],ot.prototype,"open",2),lt([m({type:Boolean,reflect:!0})],ot.prototype,"readonly",2),lt([m()],ot.prototype,"placement",2),lt([m({type:Boolean,reflect:!0})],ot.prototype,"quiet",2),lt([m({type:String})],ot.prototype,"value",2),lt([m({attribute:!1})],ot.prototype,"selectedItem",2);class Yr extends ot{constructor(){super(...arguments),this.onKeydown=t=>{const{code:e}=t;if(this.focused=!0,!e.startsWith("Arrow")||this.readonly)return;if(t.preventDefault(),e==="ArrowUp"||e==="ArrowDown")return void this.toggle(!0);const o=this.selectedItem?this.menuItems.indexOf(this.selectedItem):-1,a=this.value&&e!=="ArrowRight"?-1:1;let s=o+a;for(;this.menuItems[s]&&this.menuItems[s].disabled;)s+=a;!this.menuItems[s]||this.menuItems[s].disabled||(!this.value||s!==o)&&this.setValueFromItem(this.menuItems[s])}}static get styles(){return[dc,ns]}sizePopover(t){super.sizePopover(t),!this.quiet&&t.style.setProperty("min-width",`${this.offsetWidth}px`)}}Yr.openOverlay=async(r,t,e,o)=>await Xr.open(r,t,e,o),y("sp-picker",Yr),y("sp-textfield",Dr);function V(r,t,e){return(t=function(o){var a=function(s,i){if(typeof s!="object"||s===null)return s;var c=s[Symbol.toPrimitive];if(c!==void 0){var n=c.call(s,i||"default");if(typeof n!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(i==="string"?String:Number)(s)}(o,"string");return typeof a=="symbol"?a:String(a)}(t))in r?Object.defineProperty(r,t,{value:e,enumerable:!0,configurable:!0,writable:!0}):r[t]=e,r}customElements.define("sp-menu-item",class extends mt{static get styles(){return[...super.styles,k`
        :host {
          height: 42px;
        }
      ...
      `]}});const st={TOAST:"Toast",LIBRARY_LOADED:"LibraryLoaded",PLUGIN_LOADED:"PluginLoaded",PLUGIN_UNLOADED:"PluginUnloaded",LOCALE_SET:"LocaleSet",SEARCH_UPDATED:"SearchUpdated",ON_ACTION:"OnAction"},Ut={TOAST:"Toast",SHOW_LOADER:"ShowLoader",HIDE_LOADER:"HideLoader"};class qs extends pe{static get styles(){return[...super.styles,k`
        #item-link {
          display: flex;
...
`,Nc=Object.defineProperty,Fc=Object.getOwnPropertyDescriptor,Q=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Fc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Nc(t,e,s),s};const Qr=3840;class X extends R{constructor(){super(),this.vertical=!1,this.resizable=!1,this.collapsible=!1,this.primaryMin=0,this.primaryMax=Qr,this.secondaryMin=0,this.secondaryMax=Qr,this.firstPaneSize="auto",this.enoughChildren=!1,this.viewSize=0,this.offset=0,this.minPos=0,this.maxPos=Qr;const t=window.ResizeObserver;t&&(this.observer=new t(()=>{this.rect=void 0,this.updateMinMax()}))}static get styles(){return[Uc]}connectedCallback(){var t;super.connectedCallback(),(t=this.observer)==null||t.observe(this)}disconnectedCallback(){var t;(t=this.observer)==null||t.unobserve(this),super.disconnectedCallback()}get splitterSize(){return this._splitterSize||(this._splitterSize=this.splitter&&Math.round(parseFloat(window.getComputedStyle(this.splitter).getPropertyValue(this.vertical?"height":"width")))||2),this._splitterSize}render(){const t={"is-resized-start":this.splitterPos===this.minPos,"is-resized-end":this.splitterPos&&this.splitterPos>this.splitterSize&&this.splitterPos===this.maxPos,"is-collapsed-start":this.splitterPos===0,"is-collapsed-end":this.splitterPos&&this.splitterPos>=Math.max(this.splitterSize,this.viewSize-this.splitterSize)};return u`
            <slot
            ...
            ${this.enoughChildren?u`
                      <div
                          ...
                          class=${_o(t)}
                          role="separator"
                          aria-label=${I(this.label||void 0)}
                          tabindex=${I(this.resizable?"0":void 0)}
                          @keydown=${this.onKeydown}
                          ${Rc({start:["pointerdown",this.onPointerdown],streamInside:["pointermove",this.onPointermove],end:[["pointerup","pointercancel","pointerleave"],this.onPointerup]})}
                      >
                          ${this.resizable?u`
                                    <div id="gripper"></div>
                                `:u``}
      ...
      `]}});class Vc{constructor(){V(this,"listeners",[])}addEventListener(t,e){const o={type:t,callback:e};return this.listeners.push(o),o}removeEventListener(t){for(let e=0;e<this.listeners.length;e++)if(t===this.listeners[e])return void this.listeners.splice(e,1)}removeEventListeners(t){t.forEach(e=>{this.removeEventListener(e)})}dispatchEvent(t){this.listeners.slice().forEach(e=>{t.type===e.type&&e.callback.apply(this,[t])})}}class q extends Vc{constructor(){return super(),q._instance||(q._instance=this),q._instance}static get instance(){return q._instance||(q._instance=new q),q._instance}}V(q,"_instance",void 0);const Wc={initialized:!1,activePlugin:void 0,searchQuery:"",context:{},localeDict:{}};class D{static init(){D.appStore=function(t={},e="store"){function o(a,s,i){const c=new CustomEvent(s,{bubbles:!0,cancelable:!0,detail:i});return q.instance.dispatchEvent(c)}return new Proxy(t,function a(s,i){return{get:(c,n)=>n==="_isProxy"||(typeof c[n]=="object"&&c[n]!==null&&!c[n]._isProxy&&(c[n]=new Proxy(c[n],a(s,i))),c[n]),set:(c,n,l)=>(c[n]===l||(c[n]=l,o(0,n,i)),!0),deleteProperty:(c,n)=>(delete c[n],o(0,n,i),!0)}}(e,t))}(Wc,"app"),D.appStore.webRoot=window.libraryDev?"./src":D.libraryHost}}async function Ps(r){const t=await fetch(r);if(t.status===401)(async function(e){const o=await fetch(e,{credentials:"include"});if(o.status===401)window.open(new URL(origin).origin,"_self");else if(!o.ok)throw new Error("unable to load library JSON");o.json()})(r);else if(!t.ok)throw new Error("unable to load library JSON");return t.json()}function Nt(){return window.libraryDev}async function Gc(){const{context:r}=D.appStore;r.baseLibraryOrigin=Nt()?new URL(r.base).origin:window.location.origin;try{const t=await async function(o){const{base:a}=o,s=await Ps(Ye(a)?`${o.baseLibraryOrigin}${a}`:a),i=s.data?s:s.blocks;return i&&i.data.forEach(c=>{c.path&&(c.path.includes("://")&&(c.path=new URL(c.path).pathname),c.url=`${o.baseLibraryOrigin}${c.path}`,c.path=`${c.path}`,c.extended=!1)}),s}(r),e=await async function(o){if(o.extends){const{extends:a}=o,{origin:s}=new URL(a),i=await Ps(a),c=i.data?i:i.blocks;return c&&c.data.forEach(n=>{const{path:l}=n;if(l){const p=Ye(l);n.url=p?`${s}${l}`:l,n.path=p?`${l}`:new URL(l).pathname,n.extended=!0}}),o.extendedLibraryOrigin=s,i}return Promise.resolve()}(r);r.libraries=await async function(o,a){const s={};if(o[":type"]==="multi-sheet")for(const i of o[":names"])s[i]=o[i].data;else s.blocks=o.data;if(a)if(a[":type"]==="multi-sheet")for(const i of a[":names"])s[i]?s[i].push(...a[i].data):s[i]=a[i].data;else s.blocks=[...s.blocks||[],...a.data];return s}(t,e),q.instance.dispatchEvent(new CustomEvent(st.LIBRARY_LOADED))}catch(t){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:D.appStore.localeDict.errorLoadingLibraryJSON}})),console.error("Unable to load library",t)}}async function Os(r,t){const{appStore:e}=r,{context:o}=e,a={blocks:Nt()?"../../src/plugins/blocks/blocks.js":`${D.libraryHost}/plugins/blocks/blocks.js`,tags:Nt()?"../../src/plugins/tags/tags.js":`${D.libraryHost}/plugins/tags/tags.js`,"api-test":Nt()?"../../src/plugins/api-test/api-test.js":`${D.libraryHost}/plugins/api-test/api-test.js`};let s="plugins"in o?function(i,c){const n=c.plugins[i];if(n&&"src"in n){const{src:l}=n;return Ye(l)?`${c.baseLibraryOrigin}${l}`:l}}(t,o):function(i,c){const n=c[i];if(n)return Ye(n)?`${c.baseLibraryOrigin}${n}`:n}(t,o);if(s||(s=a[t]),s)try{const i=await import(s);o.activePlugin={config:i.default,data:e.context.libraries[t],path:s,decorate:i.decorate},q.instance.dispatchEvent(new CustomEvent(st.PLUGIN_LOADED))}catch(i){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:r.appStore.localeDict.errorLoadingPlugin}})),Ms(r),console.error(`Error loading plugin ${t}: ${i.message}`)}else q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:{variant:"negative",message:r.appStore.localeDict.unknownPlugin}}))}async function Ms(r){const{appStore:t}=r;t.context.activePlugin=void 0,q.instance.dispatchEvent(new CustomEvent(st.PLUGIN_UNLOADED))}V(D,"libraryHost","/tools/sidekick/library"),V(D,"appStore",void 0);class Jr extends ct{connectedCallback(){super.connectedCallback(),q.instance.addEventListener(st.LIBRARY_LOADED,()=>{const{context:t}=D.appStore,{libraries:e}=t,o=Object.keys(e);this.libraries=e;let a=o.includes("blocks")?"blocks":o[0];const s=new URLSearchParams(window.location.search);s.has("plugin")&&(a=s.get("plugin")),Os(D,a)}),q.instance.addEventListener(st.PLUGIN_LOADED,()=>{const{context:t}=D.appStore;if(t.activePlugin){const{activePlugin:e}=t,{searchEnabled:o}=e.config;o&&(this.searchEnabled=!0),this.pluginActive=!0,this.defaultPluginName=e.config.title.toLowerCase().replace(" ","-"),function(a,s=[]){const i=new URL(window.location.href);a.forEach(([n,l])=>{i.searchParams.set(n,l)}),s.forEach(n=>{i.searchParams.delete(n)});const{href:c}=i;window.history.pushState({path:c},"",decodeURIComponent(c))}([["plugin",this.defaultPluginName]])}}),q.instance.addEventListener(st.PLUGIN_UNLOADED,()=>{this.pluginActive=!1,this.searchEnabled=!1,this.searchActivated=!1;const t=this.renderRoot.querySelector(".middle-bar");t==null||t.classList.remove("search-active"),this.renderRoot.querySelector("sp-search").value=""})}activateSearch(){const t=this.renderRoot.querySelector(".middle-bar");this.searchActivated=!this.searchActivated,this.searchActivated?t==null||t.classList.add("search-active"):t==null||t.classList.remove("search-active");const e=this.renderRoot.querySelector("sp-search");e==null||e.focus()}async onPluginChange(t){const{value:e}=t.target;(function(){const o=new URL(window.location.href),a=`${o.origin}${o.pathname}`;window.history.pushState({path:a},"",a)})(),Ms(D),await Os(D,e)}onSearch(t){D.appStore.searchQuery=t.target.value,q.instance.dispatchEvent(new CustomEvent(st.SEARCH_UPDATED))}renderLibraries(){if(this.libraries){const t=Object.keys(this.libraries);return u`
        <sp-picker
          quiet 
      ...
      </div>`}}V(Jr,"properties",{searchActivated:{type:Boolean},pluginActive:{type:Boolean},libraries:{type:Array},searchEnabled:{type:Boolean},defaultPluginName:{type:String}}),V(Jr,"styles",k`
    .search {
      padding: 10px 5px;
      display: grid;
  ...
  `),customElements.define("library-header",Jr);class to extends ct{connectedCallback(){super.connectedCallback()}render(){return u`
      ...
      </div>`}}V(to,"properties",{heading:{type:String},description:{type:String}}),V(to,"styles",k`
    .message-container {
      width: 100%;
      height: 100%;
      display: flex;
  ...
  `),customElements.define("illustrated-message",to);const _s=()=>new Kc;class Kc{}const eo=new WeakMap,Rs=Te(class extends Uo{render(r){return $}update(r,[t]){var e;const o=t!==this.G;return o&&this.G!==void 0&&this.ot(void 0),(o||this.rt!==this.lt)&&(this.G=t,this.ct=(e=r.options)===null||e===void 0?void 0:e.host,this.ot(this.lt=r.element)),$}ot(r){var t;if(typeof this.G=="function"){const e=(t=this.ct)!==null&&t!==void 0?t:globalThis;let o=eo.get(e);o===void 0&&(o=new WeakMap,eo.set(e,o)),o.get(this.G)!==void 0&&this.G.call(this.ct,void 0),o.set(this.G,r),r!==void 0&&this.G.call(this.ct,r)}else this.G.value=r}get rt(){var r,t,e;return typeof this.G=="function"?(t=eo.get((r=this.ct)!==null&&r!==void 0?r:globalThis))===null||t===void 0?void 0:t.get(this.G):(e=this.G)===null||e===void 0?void 0:e.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});class Us extends ct{constructor(...t){super(...t),V(this,"progressContainer",_s())}connectedCallback(){super.connectedCallback(),q.instance.addEventListener(st.PLUGIN_LOADED,async()=>{const t=gt("div",{class:"plugin-root","data-testid":"plugin-root"});this.renderRoot.prepend(t),await this.loadPluginStylesheet(),t.addEventListener(Ut.SHOW_LOADER,this.displayLoader.bind(this)),t.addEventListener(Ut.TOAST,this.sendToast),t.addEventListener(Ut.HIDE_LOADER,this.hideLoader.bind(this));const{context:e}=D.appStore,{activePlugin:o}=e,a=e.plugins?e.plugins[o.config.title.toLowerCase()]:{};o.decorate(t,o.data,D.appStore.searchQuery,a),t.setAttribute("id",`${o.config.title.toLowerCase()}-plugin`)}),q.instance.addEventListener(st.PLUGIN_UNLOADED,()=>{const t=this.renderRoot.querySelector(".plugin-root");t&&(this.hideLoader(),t.remove())}),q.instance.addEventListener(st.SEARCH_UPDATED,()=>{const t=this.renderRoot.querySelector(".plugin-root");if(t){t.innerHTML="";const{context:e}=D.appStore,{activePlugin:o}=e,a=e.plugins?e.plugins[o.config.title.toLowerCase()]:{};o.decorate(t,o.data,D.appStore.searchQuery,a)}})}loadPluginStylesheet(){return new Promise(t=>{const e=document.createElement("link");e.setAttribute("rel","stylesheet"),e.onload=()=>t(),e.onerror=()=>t();const o=D.appStore.context.activePlugin.path.replace(".js",".css");e.setAttribute("href",o),e.setAttribute("type","text/css"),this.renderRoot.append(e)})}displayLoader(){var t;(t=this.progressContainer.value)==null||t.classList.add("visible")}hideLoader(){var t;(t=this.progressContainer.value)==null||t.classList.remove("visible")}sendToast(t){q.instance.dispatchEvent(new CustomEvent(Ut.TOAST,{detail:t.detail}))}render(){return u`
      <div class="progress-container" ${Rs(this.progressContainer)}>
        <sp-progress-circle indeterminate label="loading plugin"></sp-progress-circle>
      </div>
    `}}function Y(r,t={}){Y.defer=Y.defer||[];const e=o=>{Y[o]=Y[o]||((...a)=>Y.defer.push({fnname:o,args:a}))};Y.drain=Y.drain||((o,a)=>{Y[o]=a,Y.defer.filter(({fnname:s})=>o===s).forEach(({fnname:s,args:i})=>Y[s](...i))}),Y.on=(o,a)=>{Y.cases[o]=a},e("observe"),e("cwv");try{if(window.hlx=window.hlx||{},!window.hlx.rum){const s=new URLSearchParams(window.location.search).get("rum")==="on"?1:100,i=`${window.location.href.split("").reduce((l,p)=>(l<<5)-l+p.charCodeAt(0)|0,0)}-${new Date().getTime()}-${Math.random().toString(16).substr(2,14)}`,c=Math.random(),n=c*s<1;window.hlx.rum={weight:s,id:i,random:c,isSelected:n,sampleRUM:Y}}const{weight:o,id:a}=window.hlx.rum;window.hlx&&window.hlx.rum&&window.hlx.rum.isSelected&&(((s=t)=>{const i=JSON.stringify({weight:o,id:a,referer:window.location.href,checkpoint:r,...t}),c=`https://rum.hlx.page/.rum/${o}`;navigator.sendBeacon(c,i),console.debug(`ping:${r}`,s)})(t),Y.cases[r]&&Y.cases[r]())}catch(o){}}function Ns(r,t=[],e=!0){if(r){const o={},a=function(s,i=!0){const c={};return s.querySelectorAll(":scope > div").forEach(n=>{if(n.children){const l=[...n.children];if(l[1]){const p=l[1],d=i?Bs(l[0].textContent):l[0].textContent;let g=p;if(d!=="description")if(p.querySelector("a")){const h=[...p.querySelectorAll("a")];g=h.length===1?h[0].href:h.map(b=>b.href)}else if(p.querySelector("img")){const h=[...p.querySelectorAll("img")];g=h.length===1?h[0].src:h.map(b=>b.src)}else if(p.querySelector("p")){const h=[...p.querySelectorAll("p")];g=h.length===1?h[0].textContent:h.map(b=>b.textContent)}else g=n.children[1].textContent;c[d]=g}}}),c}(r,e);return Object.keys(a).forEach(s=>{t.includes(s)||(e?o[function(i){return Bs(i).replace(/-([a-z])/g,c=>c[1].toUpperCase())}(s)]=a[s]:o[s]=a[s])}),o}}function Fs(r){const t=r.querySelector(".library-metadata");if(t){const e=Ns(t,["style"]);return t.remove(),e}}function Vs(r,t=!0){if(!r)return;const e=r.className.split(" "),o=e.shift();if(!t)return o;const a=e.filter(s=>s!=="sidekick-library"&&s!=="");return a.length>0?`${o} (${a.join(", ")})`:o}V(Us,"styles",k`
    sp-sidenav {
      width: 100%;
    }
  ...
  `),customElements.define("plugin-renderer",Us);class ro extends ct{constructor(){super(),this.type="hierarchical"}onPreview(t,e){this.dispatchEvent(new CustomEvent("PreviewBlock",{detail:{path:e}})),window.open(e,"_blank")}renderNoResults(){return`
      <div class="message-container">
    ...
    `}filterBlocks(t){const e=this.renderRoot.querySelector(".message-container"),o=this.renderRoot.querySelectorAll("sp-sidenav-item"),a=this.renderRoot.querySelectorAll("sp-sidenav-item > sp-sidenav-item"),s=this.renderRoot.querySelectorAll("sp-sidenav > sp-sidenav-item");let i=!0;if(t==="")return o.forEach(c=>{c.removeAttribute("aria-hidden"),c.removeAttribute("expanded")}),void(e&&e.remove());a.forEach(c=>{var n;const l=c.getAttribute("label").toLowerCase(),p=(n=c.dataset.searchTags)!=null?n:"";l.includes(t.toLowerCase())||p.split(",").some(d=>d.toLowerCase().includes(t.toLowerCase()))?c.removeAttribute("aria-hidden"):c.setAttribute("aria-hidden",!0)}),s.forEach(c=>{let n=!1;c.querySelectorAll("sp-sidenav-item").forEach(l=>{l.hasAttribute("aria-hidden")||(n=!0,i=!1,e&&e.remove())}),n?(c.setAttribute("expanded",!0),c.removeAttribute("aria-hidden")):c.setAttribute("aria-hidden",!0)}),i&&!e&&this.renderRoot.append(gt("div",{},this.renderNoResults()))}async loadBlocks(t,e){var o;const a=new URLSearchParams(window.location.search),s=a.has("path")?a.get("path"):void 0,i=a.has("index")?a.get("index"):void 0,c=gt("div",{class:"list-container"});if(this.type==="hierarchical"){const n=gt("sp-sidenav",{variant:"multilevel","data-testid":"blocks"});c.append(n);const l=[];let p;const d=t.map(async g=>{var h,b,f,A,v;const{url:C,path:j}=g,w=async function(H){if(window.blocks||(window.blocks={}),!window.blocks[H]){const x=await fetch(`${H}.plain.html`);if(!x.ok)return;const E=await x.text(),B=new DOMParser().parseFromString(E,"text/html");window.blocks[H]=B}return window.blocks[H]}(C);try{const H=await w;if(!H)throw new Error(`An error occurred fetching ${g.name}`);const{body:x}=H.cloneNode(!0),E=(h=function(_){const z=_.querySelector(":scope > div > .library-metadata:only-child");if(z){const S=z.parentElement,T=Fs(z.parentElement);return S.remove(),T}return{}}(x))!=null?h:{},B=(b=E.type)!=null?b:void 0,M=function(_){const z=_.querySelector(".page-metadata");if(z){const S=Ns(z,[],!1);return z.remove(),S}}(x);if(B&&B.toLowerCase()==="template"){p||(p=Qe("Templates","sp-icon-file-code",!0,!1),l.push(p));const _=(f=E.name)!=null?f:g.name,z=(v=(A=E.searchtags)!=null?A:E["search-tags"])!=null?v:"",S=Qe(_,"sp-icon-file-code",!1,!0,"sp-icon-copy");z&&S.setAttribute("data-search-tags",z);const T={detail:{blockWrapper:x,blockData:g,blockURL:C,defaultLibraryMetadata:E,pageMetadata:M}};S.addEventListener("OnAction",P=>{P.preventDefault(),P.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",T))}),p.append(S),S.addEventListener("click",async()=>{this.dispatchEvent(new CustomEvent("LoadTemplate",T))}),s===j&&(p.setAttribute("expanded",!0),this.selectedItem=S,this.dispatchEvent(new CustomEvent("LoadTemplate",T)))}else{const _=Qe(g.name,"sp-icon-file-template",!0,!0,"sp-icon-preview");l.push(_),_.addEventListener("OnAction",T=>this.onPreview(T,C));const z=x.querySelectorAll(":scope > div");let S=0;z.forEach((T,P)=>{var F,O,J,W,at,Bt,ie,ze,Ce;if(S>0)return void(S-=1);const bt=(F=Fs(T))!=null?F:{},lo=T.querySelector("div[class]");let je=(O=bt.name)!=null?O:Vs(lo);const Ks=Vs(lo,!0),uo=(Bt=(at=(W=(J=bt.searchtags)!=null?J:bt["search-tags"])!=null?W:E.searchtags)!=null?at:E["search-tags"])!=null?Bt:"";(!je||je==="section-metadata")&&(je="Unnamed Item");const wt=Qe(je,"sp-icon-file-code",!1,!0,"sp-icon-copy",(ze=(ie=bt.disablecopy)!=null?ie:E.disablecopy)!=null&&ze);uo&&wt.setAttribute("data-search-tags",uo),bt.compoundBlock=!1;const mo=(Ce=T.querySelectorAll("div[class]:not(.section-metadata)").length)!=null?Ce:0;if(bt.includeNextSections){const xt=Number(bt.includeNextSections);if(!Number.isNaN(xt)){const rr=document.createElement("body");let po=0;for(;po<xt;){const Zs=T.nextElementSibling;rr.append(Zs),po+=1}rr.prepend(T),T=rr,S=xt,bt.multiSectionBlock=!0}}else if(mo>0&&(T.querySelectorAll("body > :scope > p").length>0||mo>1)){const xt=document.createElement("body");xt.append(T),T=xt,bt.compoundBlock=!0}const er={detail:{blockWrapper:T,blockNameWithVariant:Ks,blockData:g,blockURL:C,sectionLibraryMetadata:bt,defaultLibraryMetadata:E,pageMetadata:M,index:P}};wt.classList.add("descendant"),wt.setAttribute("data-index",P),wt.addEventListener("OnAction",xt=>{xt.preventDefault(),xt.stopPropagation(),this.dispatchEvent(new CustomEvent("CopyBlock",er))}),_.append(wt),wt.addEventListener("click",async()=>{this.selectedItem&&this.selectedItem.removeAttribute("selected"),wt.setAttribute("selected",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",er))}),s===j&&i===P.toString()&&(_.setAttribute("expanded",!0),this.selectedItem=wt,this.dispatchEvent(new CustomEvent("LoadBlock",er)))})}return w}catch(H){console.error(H.message),e.dispatchEvent(new CustomEvent("Toast",{detail:{message:H.message,variant:"negative"}}))}});if(await Promise.all(d),p){const g=Array.from(p.children).sort((h,b)=>h.getAttribute("label").localeCompare(b.getAttribute("label")));g==null||g.forEach(h=>p.appendChild(h))}n.append(...l.sort((g,h)=>{const b=g.getAttribute("label").toLowerCase(),f=h.getAttribute("label").toLowerCase();return b<f?-1:b>f?1:0})),setTimeout(()=>{this.selectedItem&&this.selectedItem.setAttribute("selected",!0)},1),n.querySelectorAll("sp-sidenav-item").length===0&&e.append(this.renderNoResults())}(o=this.renderRoot)==null||o.append(c)}}V(ro,"properties",{mutationObserver:{state:!1},selectedItem:{state:!1},type:{state:!0}}),V(ro,"styles",k`
    .list-container {
      width: 100%;
    }
  ...
  `),customElements.define("block-list",ro);class oo extends ct{constructor(){super(),V(this,"iframe",_s()),this.state="ready",this.extendedBlock=!1,this.mutationObserver=new MutationObserver(this.handleMutations.bind(this))}decorateIcons(t,e){t.querySelectorAll("span.icon").forEach(async o=>{if(o.classList.length<2||!o.classList[1].startsWith("icon-"))return;const a=o.classList[1].substring(5),s=await fetch(`${e}/icons/${a}.svg`);if(s.ok){const i=await s.text();if(i.match(/<style/i)){const c=document.createElement("img");c.src=`data:image/svg+xml,${encodeURIComponent(i)}`,o.appendChild(c)}else o.innerHTML=i}})}decorateEditableElements(t){t==null||t.querySelectorAll("p, li, strong, a, h1, h2, h3, h4, h5, h6").forEach(e=>{e.textContent.trim()!==""&&(e.setAttribute("contentEditable",!0),e.setAttribute("data-library-id",window.crypto.randomUUID()))}),t==null||t.querySelectorAll("a").forEach(e=>{const o=e.parentElement,a=e.parentElement.parentElement,s=o.childNodes.length===1&&o.tagName==="P",i=a.childNodes.length===1&&a.tagName==="P",c=a.childNodes.length===1&&a.tagName==="DIV",n=o.childNodes.length===1&&o.tagName==="STRONG",l=o.childNodes.length===1&&o.tagName==="EM";(s||i&&n||c&&s||i&&l)&&(o.removeAttribute("contentEditable"),o.removeAttribute("data-library-id"),a.removeAttribute("contentEditable"),a.removeAttribute("data-library-id"))}),t==null||t.querySelectorAll("img").forEach(e=>{e.setAttribute("data-library-id",window.crypto.randomUUID())})}handleMutations(t){t.forEach(e=>{var o,a,s;const{target:i,type:c}=e;let n=c!=="characterData"?i.getAttribute("data-library-id"):(o=i==null?void 0:i.parentElement)==null?void 0:o.getAttribute("data-library-id");const l=this.blockWrapperHTML.querySelector(`[data-library-id="${n}"]`);if(l){if(c==="attributes")e.attributeName==="src"&&i.tagName==="IMG"&&(l.src=i.src,l.width=i.width,l.height=i.height),e.attributeName==="href"&&i.tagName==="A"&&(l.href=i.href,l.innerText=(s=(a=i.href.split("/"))==null?void 0:a.pop())==null?void 0:s.split("?")[0]);else if(c==="characterData")n=e.target.parentElement.getAttribute("data-library-id"),l.innerHTML=e.target.parentElement.innerHTML;else if(c==="childList"&&e.addedNodes.length>0){l==null||l.replaceChildren();for(const p of e.addedNodes){const d=p.cloneNode(!0);l&&(l.textContent=d.textContent)}}}})}enableImageDragDrop(t){function e(o){o.preventDefault(),o.stopPropagation()}[...t.querySelectorAll("img")].forEach(o=>{o.addEventListener("dragover",a=>{a.target.style.outline="4px solid #54a3f6",a.target.style.outlineRadius="8px",e(a)}),o.addEventListener("dragleave",a=>{a.target.style.outline="initial",a.target.style.outlineRadius="initial",e(a)}),o.addEventListener("dragenter",a=>e(a)),o.addEventListener("drop",a=>{a.preventDefault(),a.target.style.outline="initial",a.target.style.outlineRadius="initial";const s=a.dataTransfer.files[0],i=new FileReader;i.readAsDataURL(s),i.addEventListener("loadend",()=>{const c=new Image;c.src=i.result,c.addEventListener("load",()=>{o.setAttribute("width",c.width),o.setAttribute("height",c.height)}),o.src=i.result,o.parentElement.querySelectorAll("source").forEach(n=>{n.setAttribute("srcset",i.result)})})})})}async fetchContainerPageMarkup(t,e){return(await(await fetch(t)).text()).replace(/href="\//g,`href="${e}/`).replace(/src="\//g,`src="${e}/`)}getBlockElement(){return this.blockWrapperHTML.querySelector(":scope > div:not(.section-metadata)")}getBlockWrapper(){return this.blockWrapperHTML}getBlockData(){return this.blockData}async loadBlock(t,e,o,a,s,i){var c,n,l;const{context:p}=D.appStore,{url:d}=e,g=e.extended?p.extendedLibraryOrigin:p.baseLibraryOrigin;o.innerHTML=o.innerHTML.replace(/\.\/media/g,`${g}/media`).replace(/src="\/media/g,`src="${g}/media`),this.blockWrapperHTML=o,this.blockData=e,this.isBlock=!0;let h=this.getBlockElement();(!h||a&&a.type==="template")&&(this.isBlock=!1,h=this.blockWrapperHTML);const b="sidekick-library";h==null||h.classList.add(b),((l=(n=(c=s==null?void 0:s.contenteditable)!=null?c:a==null?void 0:a.contenteditable)!=null?n:p==null?void 0:p.contentEditable)==null||l).toString()==="true"&&this.decorateEditableElements(h);const f=o.cloneNode(!0),A=await this.fetchContainerPageMarkup(d,g),v=new DOMParser().parseFromString(A,"text/html"),C=v.querySelector("body"),j=v.querySelector("main");C.classList.add(b),j.classList.add(b),v.querySelector("header").style.display="none",v.querySelector("footer").style.display="none",j.replaceChildren(f);const{value:w}=this.iframe;w.srcdoc=v.documentElement.outerHTML,w.style.display="block",w.addEventListener("load",()=>{var H;const{contentWindow:x}=w,{body:E}=x.document;Nt()&&this.decorateIcons(E,g),w.contentDocument.addEventListener("scroll",()=>{this.activeOverlayContent&&this.activeOverlayContent.remove(),this.selectedContentEditable&&this.selectedContentEditable.blur()}),x.addEventListener("focus",()=>{this.activeOverlayContent&&this.activeOverlayContent.remove()}),w.contentDocument.querySelectorAll("p, strong, li, a, h1, h2, h3, h4, h5, h6").forEach(z=>{z.addEventListener("keydown",S=>{S.keyCode===13&&S.preventDefault()})}),w.contentDocument.querySelectorAll("a, button").forEach(z=>{z.addEventListener("click",S=>{S.preventDefault(),S.stopPropagation()})}),this.enableImageDragDrop(E),this.mutationObserver.observe(E,{subtree:!0,attributes:!0,childList:!0,characterData:!0,characterDataOldValue:!0});const{window:{window:{hlx:B}}}=x,M=`${g}${(H=B==null?void 0:B.codeBasePath)!=null?H:""}`;if(Nt()&&t!==""){const z=gt("link",{rel:"stylesheet",href:`${M}/blocks/${t}/${t}.css`});w.contentWindow.document.head.append(z)}const _=gt("link",{rel:"stylesheet",href:`${M}/styles/lazy-styles.css`});w.contentWindow.document.head.append(_),_.onload=()=>{w.style.display="block",Nt()&&w.contentDocument.querySelectorAll("source").forEach(z=>{const S=z.getAttribute("srcset");S.startsWith("/media")&&z.setAttribute("srcset",`${g}${S}`)}),w.contentDocument.querySelectorAll("img").forEach(z=>{const S=z.getAttribute("src");S.startsWith("/media")&&(z.src=`${g}${S}`)})},_.onerror=z=>{console.error(z)}})}render(){return u`<iframe title="block" ${Rs(this.iframe)}></iframe>`}}V(oo,"properties",{mutationObserver:{state:!1},blockWrapperHTML:{state:!1},activeOverlayContent:{state:!1},selectedContentEditable:{state:!1},blockData:{state:!1},isBlock:{state:!1,type:Boolean},extendedBlock:{state:!0,type:Boolean}}),V(oo,"styles",k`
    iframe {
      width: 100%;
      height: 100%;
      border: none;
  ...
  `),customElements.define("block-renderer",oo);var Zc=k`
...
`,Xc=Object.defineProperty,Yc=Object.getOwnPropertyDescriptor,Ws=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Yc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Xc(t,e,s),s};class so extends R{constructor(){super(...arguments),this.label=""}static get styles(){return[Zc]}render(){return this.variant==="file"?(t=>u`
    <svg
        class="file"
        role="img"
        viewBox="0 0 128 128"
...
`)(this.label):u`
            <slot></slot>
        `}}Ws([m({type:String,reflect:!0})],so.prototype,"variant",2),Ws([m()],so.prototype,"label",2),y("sp-asset",so);var Qc=Object.defineProperty,Jc=Object.getOwnPropertyDescriptor,ao=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?Jc(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&Qc(t,e,s),s};class Je extends vt{constructor(){super(...arguments),this.checked=!1,this.readonly=!1}get focusElement(){return this.inputElement}handleChange(){if(this.readonly)return void(this.inputElement.checked=this.checked);this.checked=this.inputElement.checked;const t=new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(t)||(this.checked=!this.inputElement.checked,this.inputElement.checked=this.checked)}render(){return u`
            <input
                id="input"
                ...
                @change=${this.handleChange}
            />
        `}}ao([m({type:Boolean,reflect:!0})],Je.prototype,"checked",2),ao([m({type:Boolean,reflect:!0})],Je.prototype,"readonly",2),ao([tt("#input")],Je.prototype,"inputElement",2),y("sp-icon-checkmark75",class extends L{render(){return rt(u),(({width:r=24,height:t=24,title:e="Checkmark75"}={})=>et`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden="true"
    role="img"
...
`,rn=Object.defineProperty,on=Object.getOwnPropertyDescriptor,io=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?on(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&rn(t,e,s),s};const sn={s:u`
        <sp-icon-checkmark75
            id="checkmark"
    ...
    `,xl:u`
        ...
        ></sp-icon-dash300>
    `};class tr extends nt(Je){constructor(){super(...arguments),this.indeterminate=!1,this.invalid=!1,this.emphasized=!1}static get styles(){return[tn,Lr,en]}render(){return u`
            ${super.render()}
            <span id="box">
                ${sn[this.size]}
                ${an[this.size]}
        ...
        `}updated(t){super.updated(t),t.has("invalid")&&(this.invalid?this.inputElement.setAttribute("aria-invalid","true"):this.inputElement.removeAttribute("aria-invalid")),t.has("indeterminate")&&(this.indeterminate?this.inputElement.setAttribute("aria-checked","mixed"):this.inputElement.removeAttribute("aria-checked"))}}io([m({type:Boolean,reflect:!0})],tr.prototype,"indeterminate",2),io([m({type:Boolean,reflect:!0})],tr.prototype,"invalid",2),io([m({type:Boolean,reflect:!0})],tr.prototype,"emphasized",2),y("sp-checkbox",tr);var cn=k`
:host{--spectrum-overlay-animation-distance:var(
--spectrum-picker-m-texticon-popover-offset-y,var(--spectrum-global-dimension-size-75)
...
`,nn=Object.defineProperty,ln=Object.getOwnPropertyDescriptor,Gs=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?ln(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&nn(t,e,s),s};class co extends R{constructor(){super(...arguments),this.opened=!1,this.textOnly=!1}static get styles(){return[cn]}render(){return u`
            <slot></slot>
        `}}Gs([m({type:Boolean,reflect:!0})],co.prototype,"opened",2),Gs([m({type:Boolean,attribute:"text-only",hasChanged:()=>!1})],co.prototype,"textOnly",2),y("sp-quick-actions",co);var un=k`
...
`],pn=Object.defineProperty,dn=Object.getOwnPropertyDescriptor,yt=(r,t,e,o)=>{for(var a,s=o>1?void 0:o?dn(t,e):t,i=r.length-1;i>=0;i--)(a=r[i])&&(s=(o?a(t,e,s):a(s))||s);return o&&s&&pn(t,e,s),s};class ht extends De(nt(function(t,e){var o;const a=Array.isArray(e)?e:[e];return o=Zt,class extends t{constructor(...s){super(s),this[o]=new Map,this.managePresenceObservedSlot=()=>{let i=!1;a.forEach(c=>{const n=!!this.querySelector(c),l=this[Zt].get(c)||!1;i=i||l!==n,this[Zt].set(c,!!this.querySelector(c))}),i&&this.updateComplete.then(()=>{this.requestUpdate()})},new $e(this,{config:{childList:!0,subtree:!0},callback:()=>{this.managePresenceObservedSlot()}}),this.managePresenceObservedSlot()}get slotContentIsPresent(){if(a.length===1)return this[Zt].get(a[0])||!1;throw new Error("Multiple selectors provided to `ObserveSlotPresence` use `getSlotContentPresence(selector: string)` instead.")}getSlotContentPresence(s){if(this[Zt].has(s))return this[Zt].get(s)||!1;throw new Error(`The provided selector \`${s}\` is not being observed.`)}}}(qo(R),['[slot="cover-photo"]','[slot="preview"]']),{validSizes:["s","m"]})){constructor(){super(...arguments),this.variant="standard",this._selected=!1,this.heading="",this.horizontal=!1,this.focused=!1,this.toggles=!1,this.value="",this.subheading="",this.handleFocusin=t=>{this.focused=!0,t.composedPath()[0]===this?this.addEventListener("keydown",this.handleKeydown):this.removeEventListener("keydown",this.handleKeydown)}}static get styles(){return[as,mn,un]}get selected(){return this._selected}set selected(t){t!==this.selected&&(this._selected=t,this.requestUpdate("selected",!this._selected))}get hasCoverPhoto(){return this.getSlotContentPresence('[slot="cover-photo"]')}get hasPreview(){return this.getSlotContentPresence('[slot="preview"]')}click(){var t;(t=this.likeAnchor)==null||t.click()}handleFocusout(t){this.focused=!1,t.composedPath()[0]===this&&this.removeEventListener("keydown",this.handleKeydown)}handleKeydown(t){const{code:e}=t;switch(e){case"Space":if(this.toggleSelected(),this.toggles){t.preventDefault();break}case"Enter":case"NumpadEnter":this.click()}}handleSelectedChange(t){t.stopPropagation(),this.selected=t.target.checked,this.announceChange()}toggleSelected(){this.toggles?(this.selected=!this.selected,this.announceChange()):this.dispatchEvent(new Event("click",{bubbles:!0,composed:!0}))}announceChange(){this.dispatchEvent(new Event("change",{cancelable:!0,bubbles:!0,composed:!0}))||(this.selected=!this.selected)}stopPropagationOnHref(t){this.href&&t.stopPropagation()}handlePointerdown(t){if(t.composedPath().some(a=>a.localName==="a"))return;const e=+new Date,o=()=>{+new Date-e<200&&this.click(),this.removeEventListener("pointerup",o),this.removeEventListener("pointercancel",o)};this.addEventListener("pointerup",o),this.addEventListener("pointercancel",o)}get renderHeading(){return u`
        ...
        `}get renderPreviewImage(){return u`
            <sp-asset id="preview" variant=${I(this.asset)}>
                <slot name="preview"></slot>
            </sp-asset>
        `}get renderCoverImage(){return u`
            <sp-asset id="cover-photo" variant=${I(this.asset)}>
        ...
        `}render(){return u`
            ...
            ${this.variant==="quiet"&&this.size==="s"?u`
                  ...
                  `:u``}
        `}firstUpdated(t){super.firstUpdated(t),this.addEventListener("pointerdown",this.handlePointerdown),this.addEventListener("focusin",this.handleFocusin),this.shadowRoot.addEventListener("focusin",this.handleFocusin),this.addEventListener("focusout",this.handleFocusout)}}yt([m()],ht.prototype,"asset",2),yt([m({reflect:!0})],ht.prototype,"variant",2),yt([m({type:Boolean,reflect:!0})],ht.prototype,"selected",1),yt([m()],ht.prototype,"heading",2),yt([m({type:Boolean,reflect:!0})],ht.prototype,"horizontal",2),yt([tt("#like-anchor")],ht.prototype,"likeAnchor",2),yt([m({type:Boolean,reflect:!0})],ht.prototype,"focused",2),yt([m({type:Boolean,reflect:!0})],ht.prototype,"toggles",2),yt([m()],ht.prototype,"value",2),yt([m()],ht.prototype,"subheading",2),customElements.define("sp-card",class extends ht{render(){return u`
            <div class="body">
                <div class="header">
                    ${this.renderHeading}
                    ${this.variant==="gallery"?this.renderSubtitleAndDescription:u``}
    ...
    `}}V(no,"properties",{theme:void 0}),V(no,"styles",k`
    * {
  ...
  `),customElements.define("sidekick-library",no);
