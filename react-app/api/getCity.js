...
const getCityLocations = (countryId, attributeCode) => {
  const queryParams = `?searchCriteria[filter_groups][0][filters][0][field]=attribute_id&searchCriteria[filter_groups][0][filters][0][value]=${attributeCode}&searchCriteria[filter_groups][0][filters][0][condition_type]=eq&searchCriteria[filter_groups][0][filters][1][field]=country_id&searchCriteria[filter_groups][0][filters][1][value]=${countryId}&searchCriteria[filter_groups][0][filters][1][condition_type]=eq&searchCriteria[filter_groups][0][filters][2][field]=status&searchCriteria[filter_groups][0][filters][2][value]=1&searchCriteria[filter_groups][0][filters][2][condition_type]=eq`;
