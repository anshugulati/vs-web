...
export default async function decorate(block) {
  ...
  const [messageContentConatiner, storeTextContainer, iconContainer, paymentMethods, paymentSummary, errorPage, accountRegistration] = block.querySelectorAll(
  ...
  const [...accountRegistrationContainer] = accountRegistration.querySelectorAll('p');
  const [, ...paymentMethodsContent] = paymentMethods?.querySelectorAll('div > table > tbody > tr') || [];
  const [, ...paymentSummaryContent] = paymentSummary?.querySelectorAll('div > table > tbody > tr') || [];
  ...
  content = {
    ...
    errorPage: errorPage?.innerHTML ?? '',
    paymentSummary: paymentSummaryContent,
    accountRegistration: accountRegistrationContainer
  };
