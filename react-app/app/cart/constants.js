...
export const PAYMENT_METHODS_NOT_FOR_EGIFTS = [AppConstants.PAYMENT_METHOD_CODE_TAMARA, AppConstants.PAYMENT_METHOD_CODE_COD, AppConstants.PAYMENT_METHOD_CODE_FAWRY, AppConstants.PAYMENT_METHOD_TABBY];
export const PAYMENT_METHODS_NOT_FOR_AURA = [AppConstants.PAYMENT_METHOD_CODE_TAMARA, AppConstants.PAYMENT_METHOD_CODE_COD, AppConstants.PAYMENT_METHOD_TABBY];

export const STANDARD_DELIVERY_CODE = 'armx_s01';