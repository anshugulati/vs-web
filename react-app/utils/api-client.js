...
export async function getGraphqlClient(query, variables = {}, isMeshEndPoint = false, headerOverrides) {
  let response = null;
  try {
    const token = getSignInToken();
    ...
    let headers = {
      ...
      'Alshaya-Brand': await getConfigValue('brand'),
      'Alshaya-Market': await getConfigValue('apimesh-market'),
