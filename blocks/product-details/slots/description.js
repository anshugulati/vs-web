  ...
  attributesToShow
    .forEach((attribute) => {
      ...
      if (pdpAttribute.value) {
        attributeElement.innerHTML = `<li class="pdp-product-description__attribute--label">${pdpAttribute.label} : <span class="pdp-product-description__attribute--value">${pdpAttribute.value}</span></li>`;
