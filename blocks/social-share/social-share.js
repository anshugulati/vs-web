...
export async function createShareIcon(titleText, iconClass = 'icon-share') {
  ...
  shareLabel.classList.add('share-label');
  shareLabel.innerText = share;
  socialShareLink.append(shareLabel);
...
export async function createModal({
  ...
  const url = typeof shareUrl === 'string' || window.location.href;
...
export async function loadSocialShareModal() {
  ...
  if (resp.ok) {
    ...
    await loadCSS(`/blocks/social-share/${getBrandPath()}social-share.css`);
