...
export async function getStores(filterPudo = false) {
  ...
  if (filterPudo) {
    searchCriteriaList.push('searchCriteria[filter_groups][1][filters][0][field]=pudo_service');
    searchCriteriaList.push('searchCriteria[filter_groups][1][filters][0][value]=0');
  }
