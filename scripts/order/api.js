...
export async function createUrl(endpoint) {
...
export async function searchOrderWithIncrementId(incrementId) {
  let searchCriteria = 'searchCriteria[filter_groups][0][filters][0][field]=increment_id&';
